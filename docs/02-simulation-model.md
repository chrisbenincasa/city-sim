...
| **Sealing** | stored per Cell, **not diffused** | construction — **roads and Buildings alike** | on build, **at the point of laying** | a count, not a field. **One Tile per built Tile, and roads are ~86% of it** ([`adr/0150`](adr/0150-sealing-authors-no-width-and-a-road-seals-where-it-is-laid-not-where-its-endpoints-are.md)) |
