...
| `Borough.Formats` | The artefacts that spell things in words: the Input Log codec, and the crash artifact that wraps it. References the core; referenced by both shells. | One implementation of a format two shells must agree on |
