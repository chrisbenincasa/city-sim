...
2. ~~**How long is a game day?**~~ ~~Does the city age?~~ **Settled.** A Day is ~~8192~~ **2048** Ticks — ~~8m32s at the default speed, 17m at the slowest~~ **2m 08s at 1× and 4m 16s at the slowest rung** — and the city does not age. See [`adr/0019`](adr/0019-ticks-per-day-is-a-balance-constant-not-a-pacing-knob.md) and its second amendment, [`adr/0094`](adr/0094-a-day-is-2048-ticks-because-ticks-per-day-is-a-sampling-rate-and-not-a-length-of-life.md). ⚠ **CORRECTED 2026-08-19**: the Day moved on 2026-08-13 and both wall-clock figures moved with it — they are **derived** from it and the reference rate, so they were re-derived rather than divided, against [`01 §1`](01-player-experience.md)'s ladder, which is the document that owns them. The lesson worth keeping: the Day's length in *real seconds* is free and lives entirely in the speed control, while its length in *Ticks* is the traffic balance in disguise. Two questions wearing one name.
