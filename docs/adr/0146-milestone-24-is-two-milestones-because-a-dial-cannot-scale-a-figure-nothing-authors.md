...
> ⚠ **Corrected the same day by [`0147`](0147-base-fertility-is-ruleset-data-keyed-by-terrain-type-and-the-old-name-invented-a-field.md).**
...
[`plans/0040`](../../plans/0040-terrain-and-the-land-rows.md). Its **Shocks-and-Dial half** — Shocks,
...
- **The terrain half is startable immediately and beside milestone 12**, which is what
  [`plans/0040`](../../plans/0040-terrain-and-the-land-rows.md) records and why it was scoped out of
  sequence.
...
- **This ADR opens no [`0052`](0052-a-hash-bearing-number-is-chosen-with-a-named-ratifier-or-not-at-all.md)
  number**, and `plans/0040` records the ones the terrain half owes.
...
- **The terrain half is scoped and found to be two milestones in its turn.**
  ...
  offered a *land systems on terrain* split that was considered and not taken; `plans/0040` carries ten
