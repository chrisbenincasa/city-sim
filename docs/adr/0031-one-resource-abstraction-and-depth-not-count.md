...
- **Conservation becomes one invariant.** *Nothing is created or destroyed except at the gate* is now a single check across all nine Resources, catching a class of bug that previously needed separate Money and Goods tests.
