...
>
> ⚠ **That last clause fell on 2026-08-15, grilling `04 §7`** — [`0104`](0104-a-skill-tier-is-earned-by-attendance-and-the-credential-stays-a-wall.md). **Sorting is not the sole channel for the top tier; it is the *fast* one.** A city produces its own tier-3 adults, because [`0011`](0011-household-life-stages-and-self-generating-population.md) gave it children and `CONTEXT.md` → Life Stage already stores a child's schooling tier: when a Household's stage advances the new Young Household's adults carry a tier read off the Education Need that Household accumulated. **One clock, no per-Citizen aging and Sorting itself all stand** — a child growing up is a Life Stage advance on a Day countdown, which this ADR's own banner already established is not a second time base. What was wrong is the *exclusivity*, and it survived two amendments because each corrected the sentence beneath it rather than this one.
