...
- **Neither `adr/0024` nor `adr/0025` is amended.** Both were correct. `plans/0031`'s decision 1 is corrected in place rather than struck, because the wrong reading is the instructive part.
