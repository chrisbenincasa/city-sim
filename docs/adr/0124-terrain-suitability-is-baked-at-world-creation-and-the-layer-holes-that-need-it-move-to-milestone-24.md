...
> 🔴 **Half superseded by [`0154`](0154-base-fertility-is-ruleset-data-keyed-by-terrain-type-and-the-old-name-invented-a-field.md), 2026-08-22 — the placement stands and the artefact does not.**
>
...
> cannot serve* — is answered in the negative** by `0154`: a stored type plus a Ruleset lookup serves
