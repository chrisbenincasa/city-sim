...
- **Milestone 24's named artefact changes and its size does not.** It still owes one world-creation
  ...
  [`0042`](../../plans/0042-terrain-and-the-land-rows.md) task 2 is restated.
...
✅ **The set is five** ([`0158`](0158-terrain-is-five-types-and-base-fertility-varies-across-them-because-a-category-exclusion-is-not-an-overlay.md),
...
🔴 **And Base Fertility varies across them**, which this ADR left open and `0022` forbade. `0158` amends
