...
[The backlog](../plans/0000-board.md#deferred--longer-term-candidates) indexes these candidates and
owns their scheduling state, ownership and revisit triggers. This file supplies design rationale
and retrofit context, not a separate queue. Older status claims need verification against code
when selected. Remove completed entries; Git and PRs retain their history under
