...
| Are Districts player-drawn or automatic? | **5c** (routing), **8** (parking) | District boundaries decide whether a Goods movement is free or is a Shipment, and are the granularity of the travel-time matrix |
