...
public partial class ExpandedStudy : Node3D
{
    ...
    private Aabb AddAsset(string asset, Vector3 position, float yaw, string palette, bool anchor = false)
    {
        ...
        _instances.Add(new
        {
            ...
            yaw,
            boundsMin = new[] { b.Position.X, b.Position.Y, b.Position.Z },
    ...
    private void ShowPage()
    {
        ...
        if (_testStreet) _caption.Text = $"PROCEDURAL BUILDINGS / TEST STREET / {_view.ToUpperInvariant()}\nPass 03 bodies H1 A1 M1 W1 W2 · 3.5 m storeys · monochrome blockout · noon · Left/Right browse · Escape closes";
    ...
    public override void _Process(double delta)
    {
        ...
        try
        {
            ...
            if (++_page == Pages) { _ready = false; GetTree().Quit(); return; }
            ShowPage();
        }
