...
/// <remarks>
/// <para>
/// ⚠ <b>Three of <c>02 §9</c>'s clauses are absent and each for a different reason.</b>
...
/// same. And the <b>last</b> Trip's Fate is task 7's.
/// </para>
/// <para>
...
public readonly struct CitizenEvidence
{
    ...
    /// </summary>
    /// <remarks>
    /// ⚠ <b>This is <c>02 §9</c>'s <em>current</em> Trip and not its <em>"current or last"</em>.</b>
    /// The last one is unrecoverable today: <c>TripEngine.Release</c> frees the Trip row on the line
    /// after asserting it carries a Fate, and <c>AdvanceTravellers</c> frees the <b>Traveller</b> —
    /// which holds the only Citizen-to-Trip link there is — in the same pass, so the Fate and the
    /// association with the person who made the journey cease to exist together. That is milestone 6
    /// <b>task 7</b>, and the clause is owed until it lands.
    /// </remarks>
