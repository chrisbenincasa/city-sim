...
public sealed class Census
{
    ...
    private const int PlacementCounters = 6;
        ...
        PolicyActivity policies = default)
    {
        ...
        Write(_values, at + _placementBase, (int)PlacementCounter.Reassessed, placement.Reassessed);
        Write(_values, at + _placementBase, (int)PlacementCounter.ShortageMoves, placement.ShortageMoves);
    ...
    private int Offset(Metric metric)
    {
        ...
        if (metric.Source is MetricSource.Placement)
        {
            if (metric.PlacementCounter is not (PlacementCounter.Considered
                    ...
                    or PlacementCounter.Retired or PlacementCounter.Reassessed or PlacementCounter.ShortageMoves))
            {
                throw new ArgumentOutOfRangeException(
