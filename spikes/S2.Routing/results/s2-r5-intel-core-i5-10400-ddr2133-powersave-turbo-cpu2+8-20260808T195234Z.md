...
- **Captured** 2026-08-08 19:52:34 UTC
...
- Full abstract-graph build at **8 Chunks**: 47.36 ms measured first, 42.51 ms measured last, 1.11× apart.
- Full abstract-graph build at **16 Chunks**: 76.31 ms measured first, 78.49 ms measured last, 0.97× apart.
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 8 | drag | 1 | 1 | 1 | 0.25 ms | 0.40 ms | 0.29 ms | 0.46 ms | 1.16× | 0.53% |
| 8 | drag | 4 | 4 | 1 | 0.34 ms | 0.75 ms | 0.80 ms | 0.95 ms | 2.36× | 0.72% |
| 8 | drag | 16 | 16 | 2 | 0.70 ms | 0.89 ms | 2.82 ms | 3.91 ms | 3.97× | 1.49% |
| 8 | drag | 64 | 64 | 8 | 2.11 ms | 3.78 ms | 12.17 ms | 17.68 ms | 5.75× | 4.46% |
| 8 | drag | 256 | 173 | 15 | 3.47 ms | 4.56 ms | 25.93 ms | 39.76 ms | 7.46× | 7.33% |
| 8 | scattered | 1 | 1 | 1 | 0.25 ms | 0.37 ms | 0.26 ms | 0.49 ms | 1.04× | 0.53% |
| 8 | scattered | 4 | 4 | 4 | 1.06 ms | 1.35 ms | 0.96 ms | 1.27 ms | 0.90× | 2.24% |
| 8 | scattered | 16 | 16 | 17 | 3.93 ms | 4.23 ms | 4.00 ms | 4.32 ms | 1.01× | 8.30% |
| 8 | scattered | 64 | 64 | 62 | 14.37 ms | 15.01 ms | 15.47 ms | 16.18 ms | 1.07× | 30.34% |
| 8 | scattered | 256 | 256 | 172 | 39.01 ms | 40.45 ms | 60.65 ms | 63.99 ms | 1.55× | 82.36% |
| 16 | drag | 1 | 1 | 1 | 1.03 ms | 1.59 ms | 1.07 ms | 1.73 ms | 1.03× | 1.35% |
| 16 | drag | 4 | 4 | 1 | 1.35 ms | 2.76 ms | 4.25 ms | 6.11 ms | 3.14× | 1.77% |
| 16 | drag | 16 | 16 | 2 | 2.36 ms | 3.15 ms | 17.78 ms | 28.91 ms | 7.52× | 3.09% |
| 16 | drag | 64 | 64 | 4 | 4.74 ms | 8.56 ms | 70.31 ms | 94.45 ms | 14.81× | 6.21% |
| 16 | drag | 256 | 173 | 7 | 7.04 ms | 11.18 ms | 159.39 ms | 237.61 ms | 22.61× | 9.23% |
| 16 | scattered | 1 | 1 | 1 | 1.01 ms | 1.54 ms | 1.01 ms | 1.55 ms | 0.99× | 1.33% |
| 16 | scattered | 4 | 4 | 3 | 4.29 ms | 5.58 ms | 4.51 ms | 5.77 ms | 1.05× | 5.62% |
| 16 | scattered | 16 | 16 | 14 | 16.91 ms | 20.15 ms | 19.79 ms | 20.90 ms | 1.17× | 22.17% |
| 16 | scattered | 64 | 64 | 41 | 49.31 ms | 53.08 ms | 78.96 ms | 82.53 ms | 1.60× | 64.62% |
| 16 | scattered | 256 | 256 | 63 | 77.71 ms | 92.45 ms | 320.78 ms | 341.75 ms | 4.12× | 101.83% |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | global | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 0.71 | 1160.88 µs | 7244.75 µs |
| uniform | per-cluster | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 7.56 | 1034.76 µs | 3509.80 µs |
| uniform | per-Segment | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 41.97 | 1005.83 µs | 5229.32 µs |
| uniform | global | 64 Ticks | 64 | 49.34% | 22.26% | 28.39% | 0.17% | 0.71 | 1766.09 µs | 5339.23 µs |
| uniform | per-cluster | 64 Ticks | 64 | 70.60% | 1.00% | 28.39% | 0.17% | 7.56 | 1115.64 µs | 4096.24 µs |
| uniform | per-Segment | 64 Ticks | 64 | 71.58% | 0.02% | 28.39% | 0.14% | 41.98 | 1014.62 µs | 3895.56 µs |
| uniform | global | 16 Ticks | 256 | 20.67% | 50.92% | 28.39% | 0.70% | 0.71 | 2812.62 µs | 5783.26 µs |
| uniform | per-cluster | 16 Ticks | 256 | 65.94% | 5.66% | 28.39% | 0.70% | 7.60 | 1334.27 µs | 4833.77 µs |
| uniform | per-Segment | 16 Ticks | 256 | 69.89% | 1.70% | 28.39% | 0.63% | 42.79 | 1143.63 µs | 4515.79 µs |
| uniform | global | 4 Ticks | 1021 | 6.44% | 65.01% | 28.54% | 2.17% | 0.71 | 3437.57 µs | 7567.56 µs |
| uniform | per-cluster | 4 Ticks | 1021 | 56.93% | 14.52% | 28.54% | 1.90% | 7.61 | 1727.65 µs | 4711.86 µs |
| uniform | per-Segment | 4 Ticks | 1021 | 68.45% | 3.00% | 28.54% | 1.80% | 42.62 | 1270.66 µs | 4017.61 µs |
| decay L=256 | global | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 0.69 | 195.24 µs | 843.49 µs |
| decay L=256 | per-cluster | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 2.55 | 203.00 µs | 843.31 µs |
| decay L=256 | per-Segment | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 15.20 | 222.37 µs | 913.69 µs |
| decay L=256 | global | 64 Ticks | 64 | 47.70% | 21.41% | 30.88% | 0.51% | 0.69 | 378.92 µs | 2043.85 µs |
| decay L=256 | per-cluster | 64 Ticks | 64 | 68.09% | 1.02% | 30.88% | 0.51% | 2.55 | 229.23 µs | 1726.06 µs |
| decay L=256 | per-Segment | 64 Ticks | 64 | 69.01% | 0.09% | 30.88% | 0.21% | 15.19 | 232.76 µs | 1814.08 µs |
| decay L=256 | global | 16 Ticks | 256 | 20.28% | 48.82% | 30.88% | 0.87% | 0.69 | 566.85 µs | 3622.71 µs |
| decay L=256 | per-cluster | 16 Ticks | 256 | 65.89% | 3.22% | 30.88% | 0.87% | 2.56 | 286.50 µs | 3343.51 µs |
| decay L=256 | per-Segment | 16 Ticks | 256 | 68.18% | 0.92% | 30.88% | 0.73% | 15.35 | 281.52 µs | 2868.31 µs |
| decay L=256 | global | 4 Ticks | 1021 | 6.34% | 62.15% | 31.49% | 2.75% | 0.68 | 832.81 µs | 2440.36 µs |
| decay L=256 | per-cluster | 4 Ticks | 1021 | 60.03% | 8.47% | 31.49% | 2.75% | 2.53 | 462.42 µs | 1763.98 µs |
| decay L=256 | per-Segment | 4 Ticks | 1021 | 66.77% | 1.73% | 31.49% | 2.34% | 15.16 | 438.82 µs | 2194.92 µs |
| monocentric L=512 | global | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 0.69 | 792.68 µs | 2812.27 µs |
| monocentric L=512 | per-cluster | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 6.55 | 791.30 µs | 2770.82 µs |
| monocentric L=512 | per-Segment | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 805.09 µs | 2854.10 µs |
| monocentric L=512 | global | 64 Ticks | 64 | 48.63% | 21.14% | 30.22% | 0.00% | 0.69 | 1425.98 µs | 4291.98 µs |
| monocentric L=512 | per-cluster | 64 Ticks | 64 | 69.16% | 0.61% | 30.22% | 0.00% | 6.55 | 859.10 µs | 3071.57 µs |
| monocentric L=512 | per-Segment | 64 Ticks | 64 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 809.22 µs | 3020.01 µs |
| monocentric L=512 | global | 16 Ticks | 256 | 20.77% | 48.99% | 30.22% | 0.51% | 0.69 | 2197.88 µs | 6363.32 µs |
| monocentric L=512 | per-cluster | 16 Ticks | 256 | 65.01% | 4.76% | 30.22% | 0.51% | 6.55 | 990.99 µs | 3474.82 µs |
| monocentric L=512 | per-Segment | 16 Ticks | 256 | 68.26% | 1.51% | 30.22% | 0.51% | 37.85 | 890.97 µs | 4399.67 µs |
| monocentric L=512 | global | 4 Ticks | 1021 | 6.27% | 63.25% | 30.46% | 2.44% | 0.69 | 2752.16 µs | 9449.63 µs |
| monocentric L=512 | per-cluster | 4 Ticks | 1021 | 55.95% | 13.57% | 30.46% | 2.31% | 6.55 | 1392.26 µs | 4077.77 µs |
| monocentric L=512 | per-Segment | 4 Ticks | 1021 | 66.74% | 2.78% | 30.46% | 2.02% | 37.78 | 1039.51 µs | 3903.96 µs |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| cache | drag 1 | 1 | 0.20 ms | 0.23 ms | — | — | — |
| cache | drag 4 | 4 | 0.25 ms | 0.37 ms | — | — | — |
| cache | drag 16 | 16 | 0.60 ms | 1.04 ms | — | — | — |
| cache | drag 64 | 64 | 1.94 ms | 3.02 ms | — | — | — |
| cache | drag 256 | 173 | 3.48 ms | 5.59 ms | — | — | — |
| cache+ttl | drag 1 | 1 | 0.21 ms | 0.26 ms | — | — | — |
| cache+ttl | drag 4 | 4 | 0.25 ms | 0.38 ms | — | — | — |
| cache+ttl | drag 16 | 16 | 0.58 ms | 0.72 ms | — | — | — |
| cache+ttl | drag 64 | 64 | 1.77 ms | 2.75 ms | — | — | — |
| cache+ttl | drag 256 | 173 | 3.51 ms | 6.48 ms | — | — | — |
| nexthop | drag 1 | 1 | 0.64 ms | 1.77 ms | 0.62 ms | 1.75 ms | 0.97× |
| nexthop | drag 4 | 4 | 0.95 ms | 1.80 ms | 1.08 ms | 2.57 ms | 1.13× |
| nexthop | drag 16 | 16 | 2.03 ms | 5.33 ms | 2.52 ms | 6.63 ms | 1.24× |
| nexthop | drag 64 | 64 | 12.23 ms | 39.05 ms | 19.07 ms | 74.56 ms | 1.55× |
| nexthop | drag 256 | 173 | 21.25 ms | 47.18 ms | 30.40 ms | 87.33 ms | 1.43× |
| shared | drag 1 | 1 | 199.79 ms | 253.83 ms | — | — | — |
| shared | drag 4 | 4 | 206.19 ms | 219.97 ms | — | — | — |
| shared | drag 16 | 16 | 187.62 ms | 191.79 ms | — | — | — |
| shared | drag 64 | 64 | 208.45 ms | 256.33 ms | — | — | — |
| shared | drag 256 | 173 | 252.47 ms | 362.34 ms | — | — | — |
...
- One uncached point-to-point search, arcs returned: 928.22 µs measured first, 425.98 µs measured last, 2.17× apart.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | cache | never | 1032.96 µs | 3540.40 µs | 71.63% | 0.00% | 28.36% | — | 0 | 0.00% | 0.00% | 1.12% | 255 |
| uniform | cache+ttl 64 | never | 1902.86 µs | 4517.21 µs | 46.63% | 0.00% | 53.36% | 5.26 | 0 | 0.00% | 0.00% | 1.12% | 255 |
| uniform | cache+ttl 256 | never | 1242.16 µs | 3986.80 µs | 64.74% | 0.00% | 35.25% | 1.44 | 0 | 0.00% | 0.00% | 1.12% | 255 |
| uniform | cache+ttl 1024 | never | 1065.57 µs | 5053.97 µs | 70.06% | 0.00% | 29.93% | 0.34 | 0 | 0.00% | 0.00% | 1.12% | 255 |
| uniform | nexthop | never | 1.98 µs | 11.84 µs | — | — | — | — | 0 | 16.58% | 26.97% | 913.61% | 254 |
| uniform | shared | never | 1.68 µs | 16.88 µs | — | — | — | — | 0 | 31.21% | 56.46% | 953.61% | 249 |
| uniform | flat | never | 7017.43 µs | 12925.32 µs | — | — | — | — | 0 | 0.00% | 0.00% | 0.00% | 256 |
| uniform | cache | 64 Ticks | 1003.86 µs | 4026.06 µs | 71.58% | 0.02% | 28.39% | — | 6 | 0.00% | 0.00% | 1.12% | 254 |
| uniform | cache+ttl 64 | 64 Ticks | 1973.31 µs | 4458.60 µs | 46.58% | 0.02% | 53.39% | 5.26 | 7 | 0.00% | 0.00% | 1.12% | 254 |
| uniform | cache+ttl 256 | 64 Ticks | 1386.80 µs | 5631.90 µs | 64.69% | 0.02% | 35.27% | 1.44 | 6 | 0.00% | 0.00% | 1.12% | 254 |
| uniform | cache+ttl 1024 | 64 Ticks | 1086.95 µs | 3796.74 µs | 70.01% | 0.02% | 29.95% | 0.34 | 6 | 0.00% | 0.00% | 1.12% | 254 |
| uniform | nexthop | 64 Ticks | 16.99 µs | 1548.85 µs | — | — | — | — | 0 | 16.64% | 26.97% | 913.61% | 253 |
| uniform | shared | 64 Ticks | 2947.54 µs | 192255.04 µs | — | — | — | — | 0 | 31.28% | 56.46% | 953.61% | 248 |
| uniform | flat | 64 Ticks | 7098.49 µs | 12751.64 µs | — | — | — | — | 7 | 0.00% | 0.00% | 0.00% | 255 |
| uniform | cache | 16 Ticks | 1116.83 µs | 3920.56 µs | 69.89% | 1.70% | 28.39% | — | 26 | 0.00% | 0.00% | 1.12% | 253 |
| uniform | cache+ttl 64 | 16 Ticks | 1972.08 µs | 6901.74 µs | 45.99% | 0.43% | 53.56% | 5.25 | 28 | 0.00% | 0.00% | 1.12% | 253 |
| uniform | cache+ttl 256 | 16 Ticks | 1387.73 µs | 5542.97 µs | 63.42% | 1.12% | 35.44% | 1.44 | 27 | 0.00% | 0.00% | 1.12% | 253 |
| uniform | cache+ttl 1024 | 16 Ticks | 1734.65 µs | 11056.91 µs | 68.38% | 1.66% | 29.95% | 0.34 | 26 | 0.00% | 0.00% | 1.12% | 253 |
| uniform | nexthop | 16 Ticks | 312.49 µs | 48116.71 µs | — | — | — | — | 0 | 16.47% | 26.97% | 913.61% | 252 |
| uniform | shared | 16 Ticks | 14282.75 µs | 373975.33 µs | — | — | — | — | 0 | 30.99% | 56.66% | 953.61% | 247 |
| uniform | flat | 16 Ticks | 7769.44 µs | 16707.80 µs | — | — | — | — | 29 | 0.00% | 0.00% | 0.00% | 254 |
| uniform | cache | 4 Ticks | 1409.12 µs | 4441.47 µs | 68.45% | 3.00% | 28.54% | — | 74 | 0.00% | 0.00% | 1.12% | 250 |
| uniform | cache+ttl 64 | 4 Ticks | 2271.91 µs | 6960.85 µs | 45.31% | 0.83% | 53.85% | 5.20 | 87 | 0.00% | 0.00% | 1.12% | 250 |
| uniform | cache+ttl 256 | 4 Ticks | 1749.97 µs | 6214.26 µs | 62.13% | 2.19% | 35.66% | 1.44 | 80 | 0.00% | 0.00% | 1.12% | 250 |
| uniform | cache+ttl 1024 | 4 Ticks | 1424.97 µs | 4557.80 µs | 66.99% | 2.90% | 30.10% | 0.34 | 74 | 0.00% | 0.00% | 1.12% | 250 |
| uniform | nexthop | 4 Ticks | 961.98 µs | 66458.06 µs | — | — | — | — | 0 | 16.69% | 28.80% | 913.61% | 246 |
| uniform | shared | 4 Ticks | 51308.16 µs | 264523.68 µs | — | — | — | — | 0 | 31.27% | 56.46% | 953.61% | 241 |
| uniform | flat | 4 Ticks | 7288.37 µs | 14118.75 µs | — | — | — | — | 89 | 0.00% | 0.00% | 0.00% | 251 |
| decay L=256 | cache | never | 207.10 µs | 1154.02 µs | 69.31% | 0.00% | 30.68% | — | 0 | 0.01% | 0.00% | 3.22% | 251 |
| decay L=256 | cache+ttl 64 | never | 358.95 µs | 1018.64 µs | 45.94% | 0.00% | 54.05% | 5.07 | 0 | 0.01% | 0.00% | 3.22% | 251 |
| decay L=256 | cache+ttl 256 | never | 242.62 µs | 857.45 µs | 62.54% | 0.00% | 37.45% | 1.37 | 0 | 0.01% | 0.00% | 3.22% | 251 |
| decay L=256 | cache+ttl 1024 | never | 210.96 µs | 840.66 µs | 67.43% | 0.00% | 32.56% | 0.39 | 0 | 0.01% | 0.00% | 3.22% | 251 |
| decay L=256 | nexthop | never | 0.81 µs | 11.20 µs | — | — | — | — | 0 | 149.73% | 340.00% | 5765.28% | 250 |
| decay L=256 | shared | never | 1.06 µs | 9.88 µs | — | — | — | — | 0 | 211.94% | 603.34% | 6098.61% | 248 |
| decay L=256 | flat | never | 984.97 µs | 2736.12 µs | — | — | — | — | 0 | 0.00% | 0.00% | 0.00% | 254 |
| decay L=256 | cache | 64 Ticks | 223.42 µs | 1553.93 µs | 69.01% | 0.09% | 30.88% | — | 9 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 64 | 64 Ticks | 374.13 µs | 1822.11 µs | 45.60% | 0.02% | 54.37% | 5.04 | 21 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 256 | 64 Ticks | 261.20 µs | 1490.05 µs | 62.15% | 0.07% | 37.76% | 1.37 | 17 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 1024 | 64 Ticks | 229.07 µs | 1342.63 µs | 67.16% | 0.07% | 32.76% | 0.39 | 9 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | nexthop | 64 Ticks | 15.74 µs | 1552.00 µs | — | — | — | — | 0 | 138.91% | 340.00% | 5765.28% | 249 |
| decay L=256 | shared | 64 Ticks | 2930.65 µs | 189660.43 µs | — | — | — | — | 0 | 200.07% | 600.00% | 6098.61% | 247 |
| decay L=256 | flat | 64 Ticks | 935.72 µs | 2576.28 µs | — | — | — | — | 21 | 0.00% | 0.00% | 0.00% | 253 |
| decay L=256 | cache | 16 Ticks | 262.23 µs | 1553.90 µs | 68.18% | 0.92% | 30.88% | — | 30 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 64 | 16 Ticks | 425.10 µs | 2976.64 µs | 45.28% | 0.29% | 54.41% | 5.03 | 36 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 256 | 16 Ticks | 329.34 µs | 3036.50 µs | 61.66% | 0.53% | 37.79% | 1.37 | 32 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | cache+ttl 1024 | 16 Ticks | 308.16 µs | 4291.39 µs | 66.38% | 0.85% | 32.76% | 0.39 | 30 | 0.01% | 0.00% | 3.22% | 250 |
| decay L=256 | nexthop | 16 Ticks | 282.68 µs | 42711.90 µs | — | — | — | — | 0 | 139.10% | 340.00% | 5765.28% | 249 |
| decay L=256 | shared | 16 Ticks | 11709.77 µs | 193731.74 µs | — | — | — | — | 0 | 201.36% | 600.00% | 6098.61% | 247 |
| decay L=256 | flat | 16 Ticks | 912.11 µs | 2426.56 µs | — | — | — | — | 36 | 0.00% | 0.00% | 0.00% | 253 |
| decay L=256 | cache | 4 Ticks | 424.70 µs | 3650.88 µs | 66.77% | 1.73% | 31.49% | — | 96 | 0.01% | 0.00% | 3.22% | 245 |
| decay L=256 | cache+ttl 64 | 4 Ticks | 559.43 µs | 3563.30 µs | 44.31% | 0.58% | 55.10% | 4.96 | 113 | 0.01% | 0.00% | 3.22% | 245 |
| decay L=256 | cache+ttl 256 | 4 Ticks | 469.12 µs | 2728.90 µs | 60.25% | 1.29% | 38.45% | 1.36 | 107 | 0.01% | 0.00% | 3.22% | 245 |
| decay L=256 | cache+ttl 1024 | 4 Ticks | 426.22 µs | 2093.41 µs | 64.96% | 1.68% | 33.34% | 0.39 | 96 | 0.01% | 0.00% | 3.22% | 245 |
| decay L=256 | nexthop | 4 Ticks | 623.80 µs | 43284.14 µs | — | — | — | — | 0 | 141.67% | 340.00% | 5765.28% | 244 |
| decay L=256 | shared | 4 Ticks | 47717.37 µs | 203728.75 µs | — | — | — | — | 0 | 205.16% | 600.00% | 6098.61% | 242 |
| decay L=256 | flat | 4 Ticks | 941.41 µs | 2900.04 µs | — | — | — | — | 113 | 0.00% | 0.00% | 0.00% | 248 |
| monocentric L=512 | cache | never | 807.73 µs | 3168.32 µs | 69.77% | 0.00% | 30.22% | — | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 64 | never | 1465.74 µs | 3166.46 µs | 46.04% | 0.00% | 53.95% | 5.16 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 256 | never | 995.07 µs | 3050.33 µs | 63.06% | 0.00% | 36.93% | 1.35 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 1024 | never | 855.96 µs | 3146.42 µs | 68.11% | 0.00% | 31.88% | 0.35 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | nexthop | never | 1.46 µs | 15.32 µs | — | — | — | — | 0 | 16.58% | 39.96% | 238.57% | 251 |
| monocentric L=512 | shared | never | 1.47 µs | 16.00 µs | — | — | — | — | 0 | 33.21% | 65.63% | 706.97% | 247 |
| monocentric L=512 | flat | never | 5439.27 µs | 10708.86 µs | — | — | — | — | 0 | 0.00% | 0.00% | 0.00% | 256 |
| monocentric L=512 | cache | 64 Ticks | 827.74 µs | 3294.99 µs | 69.77% | 0.00% | 30.22% | — | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 64 | 64 Ticks | 1519.83 µs | 3292.81 µs | 46.04% | 0.00% | 53.95% | 5.16 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 256 | 64 Ticks | 1029.45 µs | 2930.63 µs | 63.06% | 0.00% | 36.93% | 1.35 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | cache+ttl 1024 | 64 Ticks | 868.73 µs | 2821.94 µs | 68.11% | 0.00% | 31.88% | 0.35 | 0 | 0.03% | 0.00% | 1.58% | 255 |
| monocentric L=512 | nexthop | 64 Ticks | 16.67 µs | 1623.87 µs | — | — | — | — | 0 | 16.58% | 39.96% | 238.57% | 251 |
| monocentric L=512 | shared | 64 Ticks | 3081.41 µs | 200604.39 µs | — | — | — | — | 0 | 33.21% | 65.63% | 706.97% | 247 |
| monocentric L=512 | flat | 64 Ticks | 5359.95 µs | 10121.45 µs | — | — | — | — | 0 | 0.00% | 0.00% | 0.00% | 256 |
| monocentric L=512 | cache | 16 Ticks | 868.26 µs | 3444.44 µs | 68.26% | 1.51% | 30.22% | — | 21 | 0.03% | 0.00% | 1.58% | 253 |
| monocentric L=512 | cache+ttl 64 | 16 Ticks | 1668.80 µs | 6008.42 µs | 45.36% | 0.46% | 54.17% | 5.15 | 21 | 0.03% | 0.00% | 1.58% | 253 |
| monocentric L=512 | cache+ttl 256 | 16 Ticks | 1098.01 µs | 4589.27 µs | 61.69% | 1.14% | 37.15% | 1.35 | 21 | 0.03% | 0.00% | 1.58% | 253 |
| monocentric L=512 | cache+ttl 1024 | 16 Ticks | 973.21 µs | 6103.53 µs | 66.74% | 1.22% | 32.03% | 0.35 | 21 | 0.03% | 0.00% | 1.58% | 253 |
| monocentric L=512 | nexthop | 16 Ticks | 285.32 µs | 43062.08 µs | — | — | — | — | 0 | 16.67% | 43.05% | 238.57% | 249 |
| monocentric L=512 | shared | 16 Ticks | 11929.31 µs | 197064.21 µs | — | — | — | — | 0 | 33.41% | 66.09% | 706.97% | 245 |
| monocentric L=512 | flat | 16 Ticks | 5431.60 µs | 12008.52 µs | — | — | — | — | 21 | 0.00% | 0.00% | 0.00% | 254 |
| monocentric L=512 | cache | 4 Ticks | 1120.69 µs | 3906.46 µs | 66.74% | 2.78% | 30.46% | — | 83 | 0.03% | 0.00% | 1.58% | 250 |
| monocentric L=512 | cache+ttl 64 | 4 Ticks | 1680.67 µs | 4854.44 µs | 44.31% | 0.83% | 54.85% | 5.08 | 99 | 0.03% | 0.00% | 1.58% | 250 |
| monocentric L=512 | cache+ttl 256 | 4 Ticks | 1200.08 µs | 3776.77 µs | 60.47% | 1.95% | 37.57% | 1.35 | 87 | 0.03% | 0.00% | 1.58% | 250 |
| monocentric L=512 | cache+ttl 1024 | 4 Ticks | 1076.10 µs | 3557.24 µs | 65.18% | 2.41% | 32.39% | 0.34 | 88 | 0.03% | 0.00% | 1.58% | 250 |
| monocentric L=512 | nexthop | 4 Ticks | 631.04 µs | 43350.84 µs | — | — | — | — | 0 | 16.75% | 43.05% | 238.57% | 246 |
| monocentric L=512 | shared | 4 Ticks | 48267.17 µs | 201673.63 µs | — | — | — | — | 0 | 33.60% | 66.09% | 706.97% | 242 |
| monocentric L=512 | flat | 4 Ticks | 5251.03 µs | 10324.93 µs | — | — | — | — | 100 | 0.00% | 0.00% | 0.00% | 251 |
...
- **Run duration** 166.00 s — from 19:52:34 UTC to 19:55:20 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 1.56 / 2.01 / 1.84 (1 / 5 / 15 min)
- **Load average, at end** 3.23 / 2.70 / 2.14 (1 / 5 / 15 min)
- **CPU stall** 2,414,704 µs over the run — 1.45% of it
- **Memory stall** 1 µs over the run — 0.00% of it
- **IO stall** 57,672 µs over the run — 0.03% of it
