...
- **Captured** 2026-08-10 02:24:26 UTC
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | 1 | 512 | 75 (14.64%) | 231 ns | 519 ns | **750 ns** | 484 ns | 682 ns | 3.82 µs | 0.951 ms | 6.10% |
| uniform | 2 | 512 | 98 (19.14%) | 231 ns | 1.21 µs | **1.44 µs** | 1.20 µs | 1.66 µs | 3.07 µs | 1.837 ms | 11.77% |
| uniform | 3 | 512 | 439 (85.74%) | 231 ns | 2.10 µs | **2.33 µs** | 2.41 µs | 2.70 µs | 6.76 µs | 2.961 ms | 18.98% |
| uniform | 4 | 512 | 451 (88.08%) | 231 ns | 3.13 µs | **3.36 µs** | 3.46 µs | 4.58 µs | 9.95 µs | 4.271 ms | 27.38% |
| uniform | 8 | 512 | 474 (92.57%) | 231 ns | 4.45 µs | **4.68 µs** | 3.65 µs | 7.86 µs | 27.89 µs | 5.945 ms | 38.11% |
| uniform | 16 | 512 | 475 (92.77%) | 231 ns | 9.09 µs | **9.32 µs** | 3.77 µs | 8.32 µs | 145.80 µs | 11.837 ms | 75.87% |
| decay L=1024 | 1 | 512 | 82 (16.01%) | 73 ns | 395 ns | **468 ns** | 387 ns | 456 ns | 1.04 µs | 0.593 ms | 3.80% |
| decay L=1024 | 2 | 512 | 104 (20.31%) | 73 ns | 983 ns | **1.05 µs** | 1.08 µs | 1.19 µs | 1.67 µs | 1.340 ms | 8.59% |
| decay L=1024 | 3 | 512 | 430 (83.98%) | 73 ns | 2.02 µs | **2.09 µs** | 2.36 µs | 2.62 µs | 5.46 µs | 2.662 ms | 17.06% |
| decay L=1024 | 4 | 512 | 446 (87.10%) | 73 ns | 3.09 µs | **3.16 µs** | 3.45 µs | 4.69 µs | 7.68 µs | 4.015 ms | 25.73% |
| decay L=1024 | 8 | 512 | 462 (90.23%) | 73 ns | 4.75 µs | **4.83 µs** | 3.70 µs | 7.86 µs | 35.13 µs | 6.129 ms | 39.29% |
| decay L=1024 | 16 | 512 | 464 (90.62%) | 73 ns | 11.53 µs | **11.60 µs** | 4.06 µs | 8.99 µs | 191.32 µs | 14.725 ms | 94.39% |
| decay L=512 | 1 | 512 | 76 (14.84%) | 59 ns | 437 ns | **496 ns** | 422 ns | 521 ns | 1.07 µs | 0.629 ms | 4.03% |
| decay L=512 | 2 | 512 | 102 (19.92%) | 59 ns | 999 ns | **1.05 µs** | 1.08 µs | 1.20 µs | 1.73 µs | 1.342 ms | 8.60% |
| decay L=512 | 3 | 512 | 419 (81.83%) | 59 ns | 2.04 µs | **2.10 µs** | 2.35 µs | 2.63 µs | 5.34 µs | 2.666 ms | 17.09% |
| decay L=512 | 4 | 512 | 436 (85.15%) | 59 ns | 3.13 µs | **3.19 µs** | 3.55 µs | 4.71 µs | 5.68 µs | 4.054 ms | 25.99% |
| decay L=512 | 8 | 512 | 458 (89.45%) | 59 ns | 5.25 µs | **5.31 µs** | 3.72 µs | 14.39 µs | 29.91 µs | 6.740 ms | 43.21% |
| decay L=512 | 16 | 512 | 458 (89.45%) | 59 ns | 13.75 µs | **13.81 µs** | 3.95 µs | 41.67 µs | 193.02 µs | 17.535 ms | 112.40% |
| decay L=256 | 1 | 512 | 88 (17.18%) | 39 ns | 406 ns | **445 ns** | 392 ns | 455 ns | 3.16 µs | 0.564 ms | 3.61% |
| decay L=256 | 2 | 512 | 126 (24.60%) | 39 ns | 981 ns | **1.02 µs** | 1.08 µs | 1.19 µs | 1.70 µs | 1.294 ms | 8.29% |
| decay L=256 | 3 | 512 | 400 (78.12%) | 39 ns | 1.98 µs | **2.02 µs** | 2.34 µs | 2.66 µs | 5.16 µs | 2.568 ms | 16.46% |
| decay L=256 | 4 | 512 | 413 (80.66%) | 39 ns | 3.10 µs | **3.14 µs** | 3.50 µs | 5.20 µs | 7.54 µs | 3.992 ms | 25.59% |
| decay L=256 | 8 | 512 | 431 (84.17%) | 39 ns | 6.07 µs | **6.10 µs** | 3.72 µs | 22.17 µs | 30.13 µs | 7.752 ms | 49.69% |
| decay L=256 | 16 | 512 | 432 (84.37%) | 39 ns | 16.86 µs | **16.90 µs** | 4.14 µs | 73.99 µs | 209.29 µs | 21.453 ms | 137.52% |
| monocentric L=512 | 1 | 512 | 57 (11.13%) | 82 ns | 433 ns | **515 ns** | 409 ns | 521 ns | 2.19 µs | 0.653 ms | 4.18% |
| monocentric L=512 | 2 | 512 | 82 (16.01%) | 82 ns | 1.06 µs | **1.14 µs** | 1.10 µs | 1.30 µs | 7.18 µs | 1.451 ms | 9.30% |
| monocentric L=512 | 3 | 512 | 427 (83.39%) | 82 ns | 2.09 µs | **2.17 µs** | 2.36 µs | 2.64 µs | 5.97 µs | 2.758 ms | 17.68% |
| monocentric L=512 | 4 | 512 | 439 (85.74%) | 82 ns | 3.17 µs | **3.25 µs** | 3.45 µs | 4.69 µs | 6.46 µs | 4.131 ms | 26.48% |
| monocentric L=512 | 8 | 512 | 469 (91.60%) | 82 ns | 4.82 µs | **4.90 µs** | 3.70 µs | 9.47 µs | 28.43 µs | 6.220 ms | 39.87% |
| monocentric L=512 | 16 | 512 | 470 (91.79%) | 82 ns | 9.86 µs | **9.95 µs** | 3.76 µs | 10.97 µs | 150.32 µs | 12.626 ms | 80.93% |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **346** | **36** | 180 | **16.89%** | 82.17% | 29.55 µs | 4,014 |
| 1 | 128 | **362** | **31** | 191 | **17.67%** | 84.65% | 37.61 µs | 6,026 |
| 2 | 256 | **368** | **31** | 197 | **17.96%** | 84.65% | 46.17 µs | 8,241 |
| 4 | 512 | **424** | **26** | 248 | **20.70%** | 87.12% | 92.68 µs | 12,936 |
| 8 | 1,024 | **488** | **25** | 311 | **23.82%** | 87.62% | 150.75 µs | 28,767 |
| 16 | 2,048 | **650** | **20** | 468 | **31.73%** | 90.09% | 340.51 µs | 68,204 |

Reverse index: **225,505 memberships** over 16,384 Cells — **110 a route** — **3.98 MiB** singly linked against the store's 500.21 KiB (8.15×), 4.94 MiB with the `previous` array. Insert **6.11 µs** a route. Evict **22.91 µs** over 6,951 chain steps singly linked, against **2.00 µs** over 110 doubly linked (11.40×). Live entries after the evictions: **0** against a high water of 225,505 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **256** | **22** | 135 | **12.51%** | 84.61% | 20.71 µs | 3,044 |
| 1 | 128 | **270** | **19** | 146 | **13.20%** | 86.71% | 25.90 µs | 4,489 |
| 2 | 256 | **277** | **19** | 153 | **13.54%** | 86.71% | 33.41 µs | 6,151 |
| 4 | 512 | **333** | **14** | 204 | **16.28%** | 90.20% | 50.67 µs | 9,948 |
| 8 | 1,024 | **403** | **12** | 272 | **19.70%** | 91.60% | 105.12 µs | 22,576 |
| 16 | 2,048 | **537** | **11** | 405 | **26.25%** | 92.30% | 264.85 µs | 54,809 |

Reverse index: **148,436 memberships** over 16,384 Cells — **72 a route** — **3.07 MiB** singly linked against the store's 383.57 KiB (8.20×), 3.80 MiB with the `previous` array. Insert **3.33 µs** a route. Evict **6.02 µs** over 2,021 chain steps singly linked, against **1.11 µs** over 72 doubly linked (5.38×). Live entries after the evictions: **0** against a high water of 148,436 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **178** | **6** | 96 | **8.70%** | 93.18% | 16.56 µs | 2,231 |
| 1 | 128 | **189** | **6** | 107 | **9.24%** | 93.18% | 18.90 µs | 3,238 |
| 2 | 256 | **202** | **5** | 119 | **9.88%** | 94.31% | 23.27 µs | 4,407 |
| 4 | 512 | **245** | **4** | 161 | **11.98%** | 95.45% | 34.65 µs | 7,226 |
| 8 | 1,024 | **307** | **3** | 222 | **15.01%** | 96.59% | 71.62 µs | 16,526 |
| 16 | 2,048 | **439** | **3** | 354 | **21.47%** | 96.59% | 183.85 µs | 40,310 |

Reverse index: **100,829 memberships** over 16,384 Cells — **49 a route** — **2.32 MiB** singly linked against the store's 288.05 KiB (8.27×), 2.87 MiB with the `previous` array. Insert **2.26 µs** a route. Evict **2.07 µs** over 760 chain steps singly linked, against **822 ns** over 49 doubly linked (2.52×). Live entries after the evictions: **0** against a high water of 100,829 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **113** | **6** | 73 | **5.56%** | 86.95% | 12.13 µs | 1,336 |
| 1 | 128 | **125** | **6** | 85 | **6.15%** | 86.95% | 13.54 µs | 1,988 |
| 2 | 256 | **142** | **3** | 99 | **6.99%** | 93.47% | 16.37 µs | 2,799 |
| 4 | 512 | **195** | **1** | 150 | **9.60%** | 97.82% | 23.27 µs | 4,727 |
| 8 | 1,024 | **260** | **0** | 214 | **12.80%** | 100.00% | 45.88 µs | 10,992 |
| 16 | 2,048 | **389** | **0** | 343 | **19.15%** | 100.00% | 122.35 µs | 27,849 |

Reverse index: **61,927 memberships** over 16,384 Cells — **30 a route** — **1.58 MiB** singly linked against the store's 192.41 KiB (8.41×), 1.94 MiB with the `previous` array. Insert **1.38 µs** a route. Evict **711 ns** over 250 chain steps singly linked, against **498 ns** over 30 doubly linked (1.42×). Live entries after the evictions: **0** against a high water of 61,927 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **219** | **24** | 121 | **10.69%** | 80.32% | 47.48 µs | 2,540 |
| 1 | 128 | **232** | **18** | 128 | **11.33%** | 85.24% | 20.63 µs | 3,800 |
| 2 | 256 | **237** | **17** | 132 | **11.57%** | 86.06% | 18.41 µs | 5,094 |
| 4 | 512 | **280** | **13** | 171 | **13.67%** | 89.34% | 29.68 µs | 7,788 |
| 8 | 1,024 | **329** | **11** | 218 | **16.07%** | 90.98% | 82.38 µs | 17,282 |
| 16 | 2,048 | **492** | **11** | 381 | **24.03%** | 90.98% | 189.81 µs | 41,678 |

Reverse index: **195,039 memberships** over 16,384 Cells — **95 a route** — **3.67 MiB** singly linked against the store's 460.50 KiB (8.17×), 4.55 MiB with the `previous` array. Insert **3.74 µs** a route. Evict **18.93 µs** over 5,495 chain steps singly linked, against **779 ns** over 95 doubly linked (24.27×). Live entries after the evictions: **0** against a high water of 195,039 — `adr/0006`'s sink, printed on the run where it reads yes.
...
- **Run duration** 6.56 s — from 02:24:26 UTC to 02:24:33 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 3.73 / 3.15 / 2.29 (1 / 5 / 15 min)
- **Load average, at end** 3.59 / 3.13 / 2.29 (1 / 5 / 15 min)
- **CPU stall** 227,148 µs over the run — 3.46% of it
- **Memory stall** 0 µs over the run — 0.00% of it
- **IO stall** 2,020 µs over the run — 0.03% of it
