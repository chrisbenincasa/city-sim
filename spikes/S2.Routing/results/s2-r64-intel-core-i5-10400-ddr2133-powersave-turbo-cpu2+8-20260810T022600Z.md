...
- **Captured** 2026-08-10 02:26:00 UTC
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | 1 | 512 | 75 (14.64%) | 243 ns | 555 ns | **798 ns** | 499 ns | 754 ns | 10.18 µs | 1.012 ms | 6.49% |
| uniform | 2 | 512 | 98 (19.14%) | 243 ns | 1.62 µs | **1.86 µs** | 1.56 µs | 2.32 µs | 6.37 µs | 2.365 ms | 15.16% |
| uniform | 3 | 512 | 439 (85.74%) | 243 ns | 3.72 µs | **3.97 µs** | 4.20 µs | 5.07 µs | 17.28 µs | 5.037 ms | 32.29% |
| uniform | 4 | 512 | 451 (88.08%) | 243 ns | 3.62 µs | **3.87 µs** | 3.79 µs | 5.65 µs | 9.12 µs | 4.911 ms | 31.48% |
| uniform | 8 | 512 | 474 (92.57%) | 243 ns | 4.63 µs | **4.88 µs** | 3.84 µs | 8.24 µs | 28.89 µs | 6.192 ms | 39.69% |
| uniform | 16 | 512 | 475 (92.77%) | 243 ns | 9.35 µs | **9.59 µs** | 3.94 µs | 8.64 µs | 145.51 µs | 12.177 ms | 78.05% |
| decay L=1024 | 1 | 512 | 82 (16.01%) | 74 ns | 477 ns | **551 ns** | 446 ns | 619 ns | 1.44 µs | 0.699 ms | 4.48% |
| decay L=1024 | 2 | 512 | 104 (20.31%) | 74 ns | 1.08 µs | **1.16 µs** | 1.15 µs | 1.39 µs | 2.53 µs | 1.472 ms | 9.43% |
| decay L=1024 | 3 | 512 | 430 (83.98%) | 74 ns | 2.10 µs | **2.17 µs** | 2.42 µs | 2.76 µs | 6.41 µs | 2.760 ms | 17.69% |
| decay L=1024 | 4 | 512 | 446 (87.10%) | 74 ns | 3.20 µs | **3.27 µs** | 3.58 µs | 4.82 µs | 6.63 µs | 4.159 ms | 26.66% |
| decay L=1024 | 8 | 512 | 462 (90.23%) | 74 ns | 5.92 µs | **6.00 µs** | 4.41 µs | 9.28 µs | 58.38 µs | 7.617 ms | 48.83% |
| decay L=1024 | 16 | 512 | 464 (90.62%) | 74 ns | 13.48 µs | **13.56 µs** | 4.34 µs | 11.01 µs | 300.00 µs | 17.208 ms | 110.31% |
| decay L=512 | 1 | 512 | 76 (14.84%) | 62 ns | 511 ns | **573 ns** | 477 ns | 669 ns | 2.26 µs | 0.727 ms | 4.66% |
| decay L=512 | 2 | 512 | 102 (19.92%) | 62 ns | 1.21 µs | **1.28 µs** | 1.16 µs | 1.88 µs | 7.67 µs | 1.625 ms | 10.42% |
| decay L=512 | 3 | 512 | 419 (81.83%) | 62 ns | 2.50 µs | **2.56 µs** | 2.54 µs | 3.90 µs | 28.15 µs | 3.257 ms | 20.88% |
| decay L=512 | 4 | 512 | 436 (85.15%) | 62 ns | 3.34 µs | **3.40 µs** | 3.72 µs | 4.98 µs | 11.54 µs | 4.317 ms | 27.67% |
| decay L=512 | 8 | 512 | 458 (89.45%) | 62 ns | 5.48 µs | **5.54 µs** | 3.94 µs | 14.43 µs | 31.82 µs | 7.037 ms | 45.11% |
| decay L=512 | 16 | 512 | 458 (89.45%) | 62 ns | 13.92 µs | **13.98 µs** | 4.09 µs | 37.33 µs | 193.42 µs | 17.744 ms | 113.74% |
| decay L=256 | 1 | 512 | 88 (17.18%) | 38 ns | 432 ns | **470 ns** | 418 ns | 511 ns | 1.24 µs | 0.596 ms | 3.82% |
| decay L=256 | 2 | 512 | 126 (24.60%) | 38 ns | 1.03 µs | **1.07 µs** | 1.11 µs | 1.27 µs | 4.41 µs | 1.357 ms | 8.70% |
| decay L=256 | 3 | 512 | 400 (78.12%) | 38 ns | 2.10 µs | **2.14 µs** | 2.42 µs | 2.79 µs | 8.01 µs | 2.720 ms | 17.44% |
| decay L=256 | 4 | 512 | 413 (80.66%) | 38 ns | 3.68 µs | **3.72 µs** | 3.98 µs | 6.04 µs | 11.45 µs | 4.728 ms | 30.30% |
| decay L=256 | 8 | 512 | 431 (84.17%) | 38 ns | 8.95 µs | **8.99 µs** | 5.02 µs | 26.38 µs | 48.43 µs | 11.408 ms | 73.13% |
| decay L=256 | 16 | 512 | 432 (84.37%) | 38 ns | 16.50 µs | **16.53 µs** | 4.10 µs | 72.43 µs | 191.37 µs | 20.987 ms | 134.53% |
| monocentric L=512 | 1 | 512 | 57 (11.13%) | 84 ns | 458 ns | **542 ns** | 425 ns | 556 ns | 3.80 µs | 0.687 ms | 4.40% |
| monocentric L=512 | 2 | 512 | 82 (16.01%) | 84 ns | 1.06 µs | **1.14 µs** | 1.11 µs | 1.30 µs | 4.23 µs | 1.454 ms | 9.32% |
| monocentric L=512 | 3 | 512 | 427 (83.39%) | 84 ns | 2.13 µs | **2.22 µs** | 2.41 µs | 2.73 µs | 3.38 µs | 2.818 ms | 18.06% |
| monocentric L=512 | 4 | 512 | 439 (85.74%) | 84 ns | 3.41 µs | **3.50 µs** | 3.65 µs | 5.27 µs | 8.22 µs | 4.444 ms | 28.48% |
| monocentric L=512 | 8 | 512 | 469 (91.60%) | 84 ns | 5.27 µs | **5.35 µs** | 4.00 µs | 10.54 µs | 35.59 µs | 6.798 ms | 43.57% |
| monocentric L=512 | 16 | 512 | 470 (91.79%) | 84 ns | 10.02 µs | **10.11 µs** | 3.91 µs | 11.16 µs | 147.41 µs | 12.830 ms | 82.24% |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **346** | **36** | 180 | **16.89%** | 82.17% | **66.03%** (35 of 53) | 29.82 µs | 4,014 |
| 1 | 128 | **362** | **31** | 191 | **17.67%** | 84.65% | **67.92%** (36 of 53) | 38.75 µs | 6,026 |
| 2 | 256 | **368** | **31** | 197 | **17.96%** | 84.65% | **67.92%** (36 of 53) | 46.80 µs | 8,241 |
| 4 | 512 | **424** | **26** | 248 | **20.70%** | 87.12% | **75.47%** (40 of 53) | 93.47 µs | 12,936 |
| 8 | 1,024 | **488** | **25** | 311 | **23.82%** | 87.62% | **75.47%** (40 of 53) | 156.16 µs | 28,767 |
| 16 | 2,048 | **650** | **20** | 468 | **31.73%** | 90.09% | **77.35%** (41 of 53) | 344.12 µs | 68,204 |

Reverse index: **225,505 memberships** over 16,384 Cells — **110 a route** — **3.98 MiB** singly linked against the store's 500.21 KiB (8.15×), 4.94 MiB with the `previous` array. Insert **6.11 µs** a route. Evict **23.74 µs** over 6,951 chain steps singly linked, against **2.07 µs** over 110 doubly linked (11.44×). Live entries after the evictions: **0** against a high water of 225,505 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **256** | **22** | 135 | **12.51%** | 84.61% | **78.94%** (30 of 38) | 20.60 µs | 3,044 |
| 1 | 128 | **270** | **19** | 146 | **13.20%** | 86.71% | **81.57%** (31 of 38) | 26.03 µs | 4,489 |
| 2 | 256 | **277** | **19** | 153 | **13.54%** | 86.71% | **81.57%** (31 of 38) | 33.27 µs | 6,151 |
| 4 | 512 | **333** | **14** | 204 | **16.28%** | 90.20% | **89.47%** (34 of 38) | 50.78 µs | 9,948 |
| 8 | 1,024 | **403** | **12** | 272 | **19.70%** | 91.60% | **89.47%** (34 of 38) | 102.47 µs | 22,576 |
| 16 | 2,048 | **537** | **11** | 405 | **26.25%** | 92.30% | **89.47%** (34 of 38) | 261.79 µs | 54,809 |

Reverse index: **148,436 memberships** over 16,384 Cells — **72 a route** — **3.07 MiB** singly linked against the store's 383.57 KiB (8.20×), 3.80 MiB with the `previous` array. Insert **3.00 µs** a route. Evict **6.04 µs** over 2,021 chain steps singly linked, against **1.08 µs** over 72 doubly linked (5.55×). Live entries after the evictions: **0** against a high water of 148,436 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **178** | **6** | 96 | **8.70%** | 93.18% | **86.48%** (32 of 37) | 17.03 µs | 2,231 |
| 1 | 128 | **189** | **6** | 107 | **9.24%** | 93.18% | **86.48%** (32 of 37) | 21.02 µs | 3,238 |
| 2 | 256 | **202** | **5** | 119 | **9.88%** | 94.31% | **89.18%** (33 of 37) | 25.56 µs | 4,407 |
| 4 | 512 | **245** | **4** | 161 | **11.98%** | 95.45% | **91.89%** (34 of 37) | 38.10 µs | 7,226 |
| 8 | 1,024 | **307** | **3** | 222 | **15.01%** | 96.59% | **94.59%** (35 of 37) | 80.17 µs | 16,526 |
| 16 | 2,048 | **439** | **3** | 354 | **21.47%** | 96.59% | **94.59%** (35 of 37) | 214.49 µs | 40,310 |

Reverse index: **100,829 memberships** over 16,384 Cells — **49 a route** — **2.32 MiB** singly linked against the store's 288.05 KiB (8.27×), 2.87 MiB with the `previous` array. Insert **2.15 µs** a route. Evict **2.07 µs** over 760 chain steps singly linked, against **829 ns** over 49 doubly linked (2.50×). Live entries after the evictions: **0** against a high water of 100,829 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **113** | **6** | 73 | **5.56%** | 86.95% | **88.88%** (16 of 18) | 12.75 µs | 1,336 |
| 1 | 128 | **125** | **6** | 85 | **6.15%** | 86.95% | **88.88%** (16 of 18) | 13.73 µs | 1,988 |
| 2 | 256 | **142** | **3** | 99 | **6.99%** | 93.47% | **94.44%** (17 of 18) | 16.23 µs | 2,799 |
| 4 | 512 | **195** | **1** | 150 | **9.60%** | 97.82% | **100.00%** (18 of 18) | 23.14 µs | 4,727 |
| 8 | 1,024 | **260** | **0** | 214 | **12.80%** | 100.00% | **100.00%** (18 of 18) | 46.33 µs | 10,992 |
| 16 | 2,048 | **389** | **0** | 343 | **19.15%** | 100.00% | **100.00%** (18 of 18) | 132.99 µs | 27,849 |

Reverse index: **61,927 memberships** over 16,384 Cells — **30 a route** — **1.58 MiB** singly linked against the store's 192.41 KiB (8.41×), 1.94 MiB with the `previous` array. Insert **1.39 µs** a route. Evict **745 ns** over 250 chain steps singly linked, against **469 ns** over 30 doubly linked (1.58×). Live entries after the evictions: **0** against a high water of 61,927 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **219** | **24** | 121 | **10.69%** | 80.32% | **74.19%** (23 of 31) | 46.42 µs | 2,540 |
| 1 | 128 | **232** | **18** | 128 | **11.33%** | 85.24% | **77.41%** (24 of 31) | 22.71 µs | 3,800 |
| 2 | 256 | **237** | **17** | 132 | **11.57%** | 86.06% | **77.41%** (24 of 31) | 18.66 µs | 5,094 |
| 4 | 512 | **280** | **13** | 171 | **13.67%** | 89.34% | **80.64%** (25 of 31) | 37.57 µs | 7,788 |
| 8 | 1,024 | **329** | **11** | 218 | **16.07%** | 90.98% | **87.09%** (27 of 31) | 68.55 µs | 17,282 |
| 16 | 2,048 | **492** | **11** | 381 | **24.03%** | 90.98% | **87.09%** (27 of 31) | 184.02 µs | 41,678 |

Reverse index: **195,039 memberships** over 16,384 Cells — **95 a route** — **3.67 MiB** singly linked against the store's 460.50 KiB (8.17×), 4.55 MiB with the `previous` array. Insert **3.51 µs** a route. Evict **18.56 µs** over 5,495 chain steps singly linked, against **869 ns** over 95 doubly linked (21.35×). Live entries after the evictions: **0** against a high water of 195,039 — `adr/0006`'s sink, printed on the run where it reads yes.
...
- **Run duration** 6.30 s — from 02:26:00 UTC to 02:26:06 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 2.54 / 2.97 / 2.31 (1 / 5 / 15 min)
- **Load average, at end** 2.41 / 2.93 / 2.30 (1 / 5 / 15 min)
- **CPU stall** 10,647 µs over the run — 0.16% of it
- **Memory stall** 0 µs over the run — 0.00% of it
- **IO stall** 1,228 µs over the run — 0.01% of it
