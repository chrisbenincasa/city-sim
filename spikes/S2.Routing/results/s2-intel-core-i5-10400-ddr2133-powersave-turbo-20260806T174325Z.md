...
- **Captured** 2026-08-06 17:42:02 UTC
...
- **Captured** 2026-08-06 17:42:03 UTC
- **Machine** Intel(R) Core(TM) i5-10400 CPU @ 2.90GHz, 1 logical processors
- **OS** Ubuntu 24.04.4 LTS, X64
- **Runtime** .NET 10.0.10
- **Governor** powersave
...
|---|---|---:|---:|---:|---:|---:|
| drive | `None` | 8,217 | 301 ns | 1,278,071 ns | 1,278,372 ns | 155 ns |
| drive | `Manhattan` | 2,813 | 421 ns | 466,599 ns | 467,020 ns | 165 ns |
| drive | `Octile` | 3,506 | 317 ns | 480,111 ns | 480,428 ns | 136 ns |
| drive | `Chebyshev` | 4,121 | 303 ns | 435,686 ns | 435,989 ns | 105 ns |
| drive | `EuclideanFloor` | 3,712 | 586 ns | 768,833 ns | 769,419 ns | 207 ns |
| walk | `None` | 276 | 250 ns | 21,400 ns | 21,651 ns | 77 ns |
| walk | `Manhattan` | 32 | 250 ns | 4,314 ns | 4,565 ns | 134 ns |
| walk | `Octile` | 46 | 256 ns | 6,322 ns | 6,579 ns | 137 ns |
| walk | `Chebyshev` | 58 | 253 ns | 6,879 ns | 7,132 ns | 118 ns |
| walk | `EuclideanFloor` | 50 | 388 ns | 10,681 ns | 11,069 ns | 213 ns |
...
- **Captured** 2026-08-06 17:42:30 UTC
- **Machine** Intel(R) Core(TM) i5-10400 CPU @ 2.90GHz, 1 logical processors
- **OS** Ubuntu 24.04.4 LTS, X64
- **Runtime** .NET 10.0.10
- **Governor** powersave
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 16 | 16 | 25.40 ms | 1,587,766 ns | 16,685 | 1.00 KiB | 56 Segments | 56.00 KiB |
| 64 | 64 | 98.45 ms | 1,538,329 ns | 16,685 | 16.00 KiB | 64 Segments | 1.00 MiB |
| 100 | 100 | 154.74 ms | 1,547,414 ns | 16,685 | 39.06 KiB | 63 Segments | 2.40 MiB |
| 121 | 121 | 188.08 ms | 1,554,396 ns | 16,685 | 57.19 KiB | 65 Segments | 3.63 MiB |
| 256 | 256 | 391.29 ms | 1,528,478 ns | 16,685 | 256.00 KiB | 65 Segments | 16.25 MiB |
| 400 | 400 | 606.77 ms | 1,516,944 ns | 16,685 | 625.00 KiB | 65 Segments | 39.67 MiB |
| 1,024 | 1,024 | 1558.17 ms | 1,521,654 ns | 16,685 | 4.00 MiB | 70 Segments | 280.00 MiB |
| 2,025 | 2,025 | 3096.72 ms | 1,529,246 ns | 16,685 | 15.64 MiB | 69 Segments | 1.05 GiB |
| 4,096 | 4,096 | 6321.73 ms | 1,543,392 ns | 16,685 | 64.00 MiB | 65 Segments | 4.06 GiB |
...
|---:|---:|---:|---:|---:|---:|
| 16 | 1.00 KiB | 0.67 ns | 1.33 ns | 1.99× | 0.09× |
| 64 | 16.00 KiB | 0.46 ns | 1.18 ns | 2.52× | 0.08× |
| 100 | 39.06 KiB | 0.55 ns | 1.20 ns | 2.17× | 0.08× |
| 121 | 57.19 KiB | 0.55 ns | 1.26 ns | 2.26× | 0.09× |
| 256 | 256.00 KiB | 0.54 ns | 1.35 ns | 2.50× | 0.09× |
| 400 | 625.00 KiB | 0.53 ns | 1.50 ns | 2.81× | 0.11× |
| 1,024 | 4.00 MiB | 0.55 ns | 1.76 ns | 3.16× | 0.12× |
| 2,025 | 15.64 MiB | 0.60 ns | 2.99 ns | 4.97× | 0.21× |
| 4,096 | 64.00 MiB | 0.60 ns | 5.77 ns | 9.47× | 0.42× |
...
|---|---|---:|---:|---:|---|
| **Centre** | Full rebuild | 121 | 182.13 ms | 0 | yes, by definition |
| | Dirty region — rows whose District touches it | 1 | 0.28 ms | 309 of 429 | **no** |
| | Routes crossing it — needs the route store | 121 rows, 430 entries | 184.94 ms | 0 of 429 | yes |
| **Corner** | Full rebuild | 121 | 181.14 ms | 0 | yes, by definition |
| | Dirty region — rows whose District touches it | 1 | 0.00 ms | 132 of 252 | **no** |
| | Routes crossing it — needs the route store | 121 rows, 253 entries | 183.39 ms | 0 of 252 | yes |
...
|---|---:|---:|---:|---:|---:|
| Day average, one matrix | 265.57 ms | 57.19 KiB | 0.08 Ticks | 0.23 Ticks | 1 |
...
| **Per phase, five matrices** | 1004.60 ms | 285.95 KiB | | | |
