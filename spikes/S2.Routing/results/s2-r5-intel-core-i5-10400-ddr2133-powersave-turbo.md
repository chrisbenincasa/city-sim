...
- **Captured** 2026-08-07 03:38:38 UTC
...
- Full abstract-graph build at **8 Chunks**: 50.88 ms measured first, 50.43 ms measured last, 1.00× apart.
- Full abstract-graph build at **16 Chunks**: 78.88 ms measured first, 83.89 ms measured last, 0.94× apart.
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 8 | drag | 1 | 1 | 1 | 0.28 ms | 0.40 ms | 0.26 ms | 0.42 ms | 0.94× | 0.55% |
| 8 | drag | 4 | 4 | 1 | 0.34 ms | 0.47 ms | 0.83 ms | 1.05 ms | 2.39× | 0.68% |
| 8 | drag | 16 | 16 | 2 | 0.66 ms | 1.09 ms | 3.42 ms | 4.73 ms | 5.15× | 1.30% |
| 8 | drag | 64 | 64 | 8 | 2.13 ms | 2.83 ms | 11.56 ms | 14.13 ms | 5.40× | 4.20% |
| 8 | drag | 256 | 173 | 15 | 3.87 ms | 6.07 ms | 28.30 ms | 43.36 ms | 7.29× | 7.62% |
| 8 | scattered | 1 | 1 | 1 | 0.33 ms | 0.62 ms | 0.28 ms | 0.54 ms | 0.84× | 0.66% |
| 8 | scattered | 4 | 4 | 4 | 1.04 ms | 1.72 ms | 1.08 ms | 1.41 ms | 1.03× | 2.05% |
| 8 | scattered | 16 | 16 | 17 | 4.13 ms | 4.56 ms | 4.06 ms | 4.44 ms | 0.98× | 8.12% |
| 8 | scattered | 64 | 64 | 62 | 15.79 ms | 16.88 ms | 16.68 ms | 19.42 ms | 1.05× | 31.04% |
| 8 | scattered | 256 | 256 | 172 | 42.23 ms | 44.28 ms | 66.27 ms | 69.78 ms | 1.56× | 82.99% |
| 16 | drag | 1 | 1 | 1 | 1.05 ms | 1.64 ms | 1.08 ms | 1.79 ms | 1.02× | 1.33% |
| 16 | drag | 4 | 4 | 1 | 1.52 ms | 3.16 ms | 4.44 ms | 6.58 ms | 2.92× | 1.92% |
| 16 | drag | 16 | 16 | 2 | 2.41 ms | 3.18 ms | 17.06 ms | 27.39 ms | 7.06× | 3.06% |
| 16 | drag | 64 | 64 | 4 | 5.10 ms | 7.89 ms | 70.05 ms | 91.82 ms | 13.73× | 6.46% |
| 16 | drag | 256 | 173 | 7 | 7.27 ms | 11.76 ms | 158.46 ms | 209.69 ms | 21.78× | 9.22% |
| 16 | scattered | 1 | 1 | 1 | 1.01 ms | 1.63 ms | 0.97 ms | 1.51 ms | 0.95× | 1.28% |
| 16 | scattered | 4 | 4 | 3 | 4.60 ms | 5.79 ms | 4.76 ms | 5.70 ms | 1.03× | 5.83% |
| 16 | scattered | 16 | 16 | 14 | 17.82 ms | 21.05 ms | 20.48 ms | 22.51 ms | 1.14× | 22.59% |
| 16 | scattered | 64 | 64 | 41 | 53.33 ms | 70.44 ms | 83.49 ms | 88.75 ms | 1.56× | 67.60% |
| 16 | scattered | 256 | 256 | 63 | 78.01 ms | 83.22 ms | 340.71 ms | 353.82 ms | 4.36× | 98.90% |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | global | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 0.71 | 1061.92 µs | 4802.85 µs |
| uniform | per-cluster | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 7.56 | 1072.89 µs | 4655.38 µs |
| uniform | per-Segment | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 41.97 | 1129.04 µs | 6576.22 µs |
| uniform | global | 64 Ticks | 64 | 49.36% | 22.26% | 28.36% | 0.00% | 0.71 | 1903.11 µs | 6050.01 µs |
| uniform | per-cluster | 64 Ticks | 64 | 70.62% | 1.00% | 28.36% | 0.00% | 7.56 | 1148.76 µs | 3807.31 µs |
| uniform | per-Segment | 64 Ticks | 64 | 71.60% | 0.02% | 28.36% | 0.00% | 41.97 | 1090.90 µs | 4341.94 µs |
| uniform | global | 16 Ticks | 256 | 20.87% | 50.75% | 28.36% | 0.00% | 0.71 | 3017.50 µs | 7313.94 µs |
| uniform | per-cluster | 16 Ticks | 256 | 66.25% | 5.37% | 28.36% | 0.00% | 7.60 | 1384.37 µs | 5599.85 µs |
| uniform | per-Segment | 16 Ticks | 256 | 70.19% | 1.44% | 28.36% | 0.00% | 42.79 | 1374.67 µs | 5856.01 µs |
| uniform | global | 4 Ticks | 1021 | 6.59% | 65.03% | 28.36% | 0.00% | 0.71 | 3593.69 µs | 7564.64 µs |
| uniform | per-cluster | 4 Ticks | 1021 | 57.49% | 14.13% | 28.36% | 0.00% | 7.64 | 1977.30 µs | 5360.36 µs |
| uniform | per-Segment | 4 Ticks | 1021 | 68.99% | 2.63% | 28.36% | 0.00% | 42.80 | 1412.84 µs | 4757.62 µs |
| decay L=256 | global | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 0.69 | 215.98 µs | 1030.63 µs |
| decay L=256 | per-cluster | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 2.55 | 218.81 µs | 980.07 µs |
| decay L=256 | per-Segment | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 15.20 | 205.95 µs | 912.64 µs |
| decay L=256 | global | 64 Ticks | 64 | 47.99% | 21.31% | 30.68% | 0.00% | 0.69 | 402.54 µs | 2142.96 µs |
| decay L=256 | per-cluster | 64 Ticks | 64 | 68.53% | 0.78% | 30.68% | 0.00% | 2.55 | 256.38 µs | 1840.29 µs |
| decay L=256 | per-Segment | 64 Ticks | 64 | 69.21% | 0.09% | 30.68% | 0.00% | 15.20 | 238.22 µs | 2150.72 µs |
| decay L=256 | global | 16 Ticks | 256 | 20.50% | 48.80% | 30.68% | 0.00% | 0.69 | 612.13 µs | 2530.79 µs |
| decay L=256 | per-cluster | 16 Ticks | 256 | 66.40% | 2.90% | 30.68% | 0.00% | 2.56 | 349.64 µs | 2154.18 µs |
| decay L=256 | per-Segment | 16 Ticks | 256 | 68.57% | 0.73% | 30.68% | 0.00% | 15.35 | 337.48 µs | 2773.29 µs |
| decay L=256 | global | 4 Ticks | 1021 | 6.51% | 62.71% | 30.76% | 0.09% | 0.69 | 875.19 µs | 3079.68 µs |
| decay L=256 | per-cluster | 4 Ticks | 1021 | 61.27% | 7.95% | 30.76% | 0.09% | 2.56 | 481.93 µs | 1686.46 µs |
| decay L=256 | per-Segment | 4 Ticks | 1021 | 67.84% | 1.39% | 30.76% | 0.09% | 15.36 | 501.94 µs | 2811.76 µs |
| monocentric L=512 | global | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 0.69 | 844.28 µs | 3167.46 µs |
| monocentric L=512 | per-cluster | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 6.55 | 839.57 µs | 2985.03 µs |
| monocentric L=512 | per-Segment | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 877.83 µs | 3704.52 µs |
| monocentric L=512 | global | 64 Ticks | 64 | 48.63% | 21.14% | 30.22% | 0.00% | 0.69 | 1652.46 µs | 5345.23 µs |
| monocentric L=512 | per-cluster | 64 Ticks | 64 | 69.16% | 0.61% | 30.22% | 0.00% | 6.55 | 897.32 µs | 3363.80 µs |
| monocentric L=512 | per-Segment | 64 Ticks | 64 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 825.13 µs | 2889.93 µs |
| monocentric L=512 | global | 16 Ticks | 256 | 20.94% | 48.82% | 30.22% | 0.00% | 0.69 | 2376.69 µs | 7777.63 µs |
| monocentric L=512 | per-cluster | 16 Ticks | 256 | 65.42% | 4.34% | 30.22% | 0.00% | 6.55 | 1086.33 µs | 5252.26 µs |
| monocentric L=512 | per-Segment | 16 Ticks | 256 | 68.67% | 1.09% | 30.22% | 0.00% | 37.85 | 937.13 µs | 5115.70 µs |
| monocentric L=512 | global | 4 Ticks | 1021 | 6.44% | 63.33% | 30.22% | 0.00% | 0.69 | 3053.66 µs | 11669.73 µs |
| monocentric L=512 | per-cluster | 4 Ticks | 1021 | 57.10% | 12.67% | 30.22% | 0.00% | 6.56 | 1497.64 µs | 4097.42 µs |
| monocentric L=512 | per-Segment | 4 Ticks | 1021 | 67.70% | 2.07% | 30.22% | 0.00% | 37.87 | 1178.95 µs | 4112.14 µs |
...
- **Run duration** 34.00 s — from 03:38:38 UTC to 03:39:12 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 2.56 / 2.40 / 2.36 (1 / 5 / 15 min)
- **Load average, at end** 2.84 / 2.49 / 2.39 (1 / 5 / 15 min)
- **CPU stall** 301,788 µs over the run — 0.88% of it
- **Memory stall** 0 µs over the run — 0.00% of it
- **IO stall** 16,658 µs over the run — 0.04% of it
