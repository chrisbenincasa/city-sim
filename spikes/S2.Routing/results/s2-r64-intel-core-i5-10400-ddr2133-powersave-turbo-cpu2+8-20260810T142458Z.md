...
- **Captured** 2026-08-10 14:24:58 UTC
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | 1 | 512 | 75 (14.64%) | 237 ns | 475 ns | **712 ns** | 458 ns | 577 ns | 2.10 µs | 0.903 ms | 5.79% |
| uniform | 2 | 512 | 98 (19.14%) | 237 ns | 1.06 µs | **1.30 µs** | 1.11 µs | 1.34 µs | 6.09 µs | 1.652 ms | 10.59% |
| uniform | 3 | 512 | 439 (85.74%) | 237 ns | 2.06 µs | **2.30 µs** | 2.38 µs | 2.67 µs | 6.13 µs | 2.925 ms | 18.75% |
| uniform | 4 | 512 | 451 (88.08%) | 237 ns | 3.21 µs | **3.45 µs** | 3.55 µs | 4.73 µs | 12.13 µs | 4.380 ms | 28.08% |
| uniform | 8 | 512 | 474 (92.57%) | 237 ns | 4.88 µs | **5.12 µs** | 4.00 µs | 8.45 µs | 36.80 µs | 6.504 ms | 41.69% |
| uniform | 16 | 512 | 475 (92.77%) | 237 ns | 9.26 µs | **9.50 µs** | 3.91 µs | 8.29 µs | 144.93 µs | 12.055 ms | 77.27% |
| decay L=1024 | 1 | 512 | 82 (16.01%) | 72 ns | 406 ns | **478 ns** | 402 ns | 470 ns | 998 ns | 0.606 ms | 3.88% |
| decay L=1024 | 2 | 512 | 104 (20.31%) | 72 ns | 1.00 µs | **1.07 µs** | 1.08 µs | 1.22 µs | 5.22 µs | 1.365 ms | 8.75% |
| decay L=1024 | 3 | 512 | 430 (83.98%) | 72 ns | 2.03 µs | **2.10 µs** | 2.36 µs | 2.64 µs | 5.57 µs | 2.672 ms | 17.13% |
| decay L=1024 | 4 | 512 | 446 (87.10%) | 72 ns | 3.12 µs | **3.19 µs** | 3.42 µs | 4.75 µs | 16.00 µs | 4.054 ms | 25.99% |
| decay L=1024 | 8 | 512 | 462 (90.23%) | 72 ns | 4.85 µs | **4.92 µs** | 3.80 µs | 7.82 µs | 32.11 µs | 6.253 ms | 40.08% |
| decay L=1024 | 16 | 512 | 464 (90.62%) | 72 ns | 10.49 µs | **10.57 µs** | 3.75 µs | 8.25 µs | 184.69 µs | 13.414 ms | 85.99% |
| decay L=512 | 1 | 512 | 76 (14.84%) | 62 ns | 503 ns | **565 ns** | 465 ns | 603 ns | 8.88 µs | 0.716 ms | 4.59% |
| decay L=512 | 2 | 512 | 102 (19.92%) | 62 ns | 1.14 µs | **1.20 µs** | 1.16 µs | 1.49 µs | 8.15 µs | 1.525 ms | 9.77% |
| decay L=512 | 3 | 512 | 419 (81.83%) | 62 ns | 2.09 µs | **2.15 µs** | 2.38 µs | 2.68 µs | 7.75 µs | 2.735 ms | 17.53% |
| decay L=512 | 4 | 512 | 436 (85.15%) | 62 ns | 3.17 µs | **3.23 µs** | 3.56 µs | 4.68 µs | 11.84 µs | 4.102 ms | 26.29% |
| decay L=512 | 8 | 512 | 458 (89.45%) | 62 ns | 5.24 µs | **5.31 µs** | 3.71 µs | 14.05 µs | 30.10 µs | 6.738 ms | 43.19% |
| decay L=512 | 16 | 512 | 458 (89.45%) | 62 ns | 13.46 µs | **13.53 µs** | 3.86 µs | 37.50 µs | 188.53 µs | 17.169 ms | 110.06% |
| decay L=256 | 1 | 512 | 88 (17.18%) | 41 ns | 399 ns | **440 ns** | 392 ns | 464 ns | 943 ns | 0.558 ms | 3.57% |
| decay L=256 | 2 | 512 | 126 (24.60%) | 41 ns | 970 ns | **1.01 µs** | 1.07 µs | 1.18 µs | 1.63 µs | 1.282 ms | 8.22% |
| decay L=256 | 3 | 512 | 400 (78.12%) | 41 ns | 1.99 µs | **2.03 µs** | 2.34 µs | 2.65 µs | 6.87 µs | 2.579 ms | 16.53% |
| decay L=256 | 4 | 512 | 413 (80.66%) | 41 ns | 3.11 µs | **3.15 µs** | 3.53 µs | 5.19 µs | 15.15 µs | 4.006 ms | 25.68% |
| decay L=256 | 8 | 512 | 431 (84.17%) | 41 ns | 6.07 µs | **6.11 µs** | 3.66 µs | 21.62 µs | 43.17 µs | 7.759 ms | 49.74% |
| decay L=256 | 16 | 512 | 432 (84.37%) | 41 ns | 16.10 µs | **16.14 µs** | 3.90 µs | 71.06 µs | 186.67 µs | 20.484 ms | 131.30% |
| monocentric L=512 | 1 | 512 | 57 (11.13%) | 87 ns | 502 ns | **589 ns** | 467 ns | 696 ns | 1.86 µs | 0.747 ms | 4.79% |
| monocentric L=512 | 2 | 512 | 82 (16.01%) | 87 ns | 1.30 µs | **1.38 µs** | 1.21 µs | 1.90 µs | 8.61 µs | 1.760 ms | 11.28% |
| monocentric L=512 | 3 | 512 | 427 (83.39%) | 87 ns | 2.20 µs | **2.29 µs** | 2.39 µs | 2.81 µs | 7.16 µs | 2.913 ms | 18.67% |
| monocentric L=512 | 4 | 512 | 439 (85.74%) | 87 ns | 3.21 µs | **3.29 µs** | 3.47 µs | 4.71 µs | 8.46 µs | 4.186 ms | 26.83% |
| monocentric L=512 | 8 | 512 | 469 (91.60%) | 87 ns | 4.86 µs | **4.95 µs** | 3.75 µs | 10.40 µs | 27.27 µs | 6.289 ms | 40.31% |
| monocentric L=512 | 16 | 512 | 470 (91.79%) | 87 ns | 10.14 µs | **10.23 µs** | 3.94 µs | 12.68 µs | 164.83 µs | 12.984 ms | 83.23% |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **346** | **36** | 180 | **16.89%** | 82.17% | **82.38%** (159 of 193) | 32.69 µs | 4,014 |
| 1 | 128 | **362** | **31** | 191 | **17.67%** | 84.65% | **84.97%** (164 of 193) | 39.03 µs | 6,026 |
| 2 | 256 | **368** | **31** | 197 | **17.96%** | 84.65% | **84.97%** (164 of 193) | 47.32 µs | 8,241 |
| 4 | 512 | **424** | **26** | 248 | **20.70%** | 87.12% | **87.56%** (169 of 193) | 93.55 µs | 12,936 |
| 8 | 1,024 | **488** | **25** | 311 | **23.82%** | 87.62% | **88.08%** (170 of 193) | 153.13 µs | 28,767 |
| 16 | 2,048 | **650** | **20** | 468 | **31.73%** | 90.09% | **90.67%** (175 of 193) | 341.53 µs | 68,204 |

Reverse index: **225,505 memberships** over 16,384 Cells — **110 a route** — **3.98 MiB** singly linked against the store's 500.21 KiB (8.15×), 4.94 MiB with the `previous` array. Insert **5.98 µs** a route. Evict **23.10 µs** over 6,951 chain steps singly linked, against **2.08 µs** over 110 doubly linked (11.06×). Live entries after the evictions: **0** against a high water of 225,505 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **256** | **22** | 135 | **12.51%** | 84.61% | **85.00%** (119 of 140) | 20.76 µs | 3,044 |
| 1 | 128 | **270** | **19** | 146 | **13.20%** | 86.71% | **87.14%** (122 of 140) | 28.00 µs | 4,489 |
| 2 | 256 | **277** | **19** | 153 | **13.54%** | 86.71% | **87.14%** (122 of 140) | 34.55 µs | 6,151 |
| 4 | 512 | **333** | **14** | 204 | **16.28%** | 90.20% | **90.71%** (127 of 140) | 51.73 µs | 9,948 |
| 8 | 1,024 | **403** | **12** | 272 | **19.70%** | 91.60% | **91.42%** (128 of 140) | 103.51 µs | 22,576 |
| 16 | 2,048 | **537** | **11** | 405 | **26.25%** | 92.30% | **92.14%** (129 of 140) | 261.65 µs | 54,809 |

Reverse index: **148,436 memberships** over 16,384 Cells — **72 a route** — **3.07 MiB** singly linked against the store's 383.57 KiB (8.20×), 3.80 MiB with the `previous` array. Insert **2.97 µs** a route. Evict **6.01 µs** over 2,021 chain steps singly linked, against **1.13 µs** over 72 doubly linked (5.28×). Live entries after the evictions: **0** against a high water of 148,436 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **178** | **6** | 96 | **8.70%** | 93.18% | **93.02%** (80 of 86) | 16.93 µs | 2,231 |
| 1 | 128 | **189** | **6** | 107 | **9.24%** | 93.18% | **93.02%** (80 of 86) | 20.16 µs | 3,238 |
| 2 | 256 | **202** | **5** | 119 | **9.88%** | 94.31% | **94.18%** (81 of 86) | 23.87 µs | 4,407 |
| 4 | 512 | **245** | **4** | 161 | **11.98%** | 95.45% | **95.34%** (82 of 86) | 35.24 µs | 7,226 |
| 8 | 1,024 | **307** | **3** | 222 | **15.01%** | 96.59% | **96.51%** (83 of 86) | 72.52 µs | 16,526 |
| 16 | 2,048 | **439** | **3** | 354 | **21.47%** | 96.59% | **96.51%** (83 of 86) | 184.26 µs | 40,310 |

Reverse index: **100,829 memberships** over 16,384 Cells — **49 a route** — **2.32 MiB** singly linked against the store's 288.05 KiB (8.27×), 2.87 MiB with the `previous` array. Insert **2.15 µs** a route. Evict **2.06 µs** over 760 chain steps singly linked, against **745 ns** over 49 doubly linked (2.77×). Live entries after the evictions: **0** against a high water of 100,829 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **113** | **6** | 73 | **5.56%** | 86.95% | **88.37%** (38 of 43) | 12.52 µs | 1,336 |
| 1 | 128 | **125** | **6** | 85 | **6.15%** | 86.95% | **88.37%** (38 of 43) | 13.60 µs | 1,988 |
| 2 | 256 | **142** | **3** | 99 | **6.99%** | 93.47% | **95.34%** (41 of 43) | 16.57 µs | 2,799 |
| 4 | 512 | **195** | **1** | 150 | **9.60%** | 97.82% | **97.67%** (42 of 43) | 23.05 µs | 4,727 |
| 8 | 1,024 | **260** | **0** | 214 | **12.80%** | 100.00% | **100.00%** (43 of 43) | 47.11 µs | 10,992 |
| 16 | 2,048 | **389** | **0** | 343 | **19.15%** | 100.00% | **100.00%** (43 of 43) | 124.03 µs | 27,849 |

Reverse index: **61,927 memberships** over 16,384 Cells — **30 a route** — **1.58 MiB** singly linked against the store's 192.41 KiB (8.41×), 1.94 MiB with the `previous` array. Insert **1.46 µs** a route. Evict **701 ns** over 250 chain steps singly linked, against **471 ns** over 30 doubly linked (1.48×). Live entries after the evictions: **0** against a high water of 61,927 — `adr/0006`'s sink, printed on the run where it reads yes.
...
| `d`, Cells | `d`, m | `\|W(d)\|` | `\|C \ W(d)\|` missed | `\|W(d) \ C\|` needless | `P(stale)` | Caught of `C` | **Caught of material `C`** | Query | Chain steps |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | **219** | **24** | 121 | **10.69%** | 80.32% | **80.34%** (94 of 117) | 48.99 µs | 2,540 |
| 1 | 128 | **232** | **18** | 128 | **11.33%** | 85.24% | **85.47%** (100 of 117) | 17.08 µs | 3,800 |
| 2 | 256 | **237** | **17** | 132 | **11.57%** | 86.06% | **85.47%** (100 of 117) | 18.79 µs | 5,094 |
| 4 | 512 | **280** | **13** | 171 | **13.67%** | 89.34% | **88.88%** (104 of 117) | 29.11 µs | 7,788 |
| 8 | 1,024 | **329** | **11** | 218 | **16.07%** | 90.98% | **90.59%** (106 of 117) | 69.46 µs | 17,282 |
| 16 | 2,048 | **492** | **11** | 381 | **24.03%** | 90.98% | **90.59%** (106 of 117) | 191.56 µs | 41,678 |

Reverse index: **195,039 memberships** over 16,384 Cells — **95 a route** — **3.67 MiB** singly linked against the store's 460.50 KiB (8.17×), 4.55 MiB with the `previous` array. Insert **3.74 µs** a route. Evict **17.77 µs** over 5,495 chain steps singly linked, against **1.42 µs** over 95 doubly linked (12.49×). Live entries after the evictions: **0** against a high water of 195,039 — `adr/0006`'s sink, printed on the run where it reads yes.
...
- **Run duration** 6.56 s — from 14:24:58 UTC to 14:25:05 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 1.73 / 1.66 / 1.88 (1 / 5 / 15 min)
- **Load average, at end** 1.75 / 1.66 / 1.88 (1 / 5 / 15 min)
- **CPU stall** 38,446 µs over the run — 0.58% of it
- **Memory stall** 0 µs over the run — 0.00% of it
- **IO stall** 1,277 µs over the run — 0.01% of it
