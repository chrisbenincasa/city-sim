...
- **Captured** 2026-08-07 12:08:34 UTC
...
- Full abstract-graph build at **8 Chunks**: 43.14 ms measured first, 46.64 ms measured last, 0.92× apart.
- Full abstract-graph build at **16 Chunks**: 75.31 ms measured first, 81.31 ms measured last, 0.92× apart.
...
| 8 | drag | 4 | 4 | 1 | 0.32 ms | 0.75 ms | 0.80 ms | 1.07 ms | 2.51× | 0.74% |
| 8 | drag | 16 | 16 | 2 | 0.77 ms | 1.10 ms | 2.81 ms | 3.61 ms | 3.65× | 1.78% |
| 8 | drag | 64 | 64 | 8 | 2.00 ms | 3.20 ms | 12.44 ms | 18.68 ms | 6.21× | 4.64% |
| 8 | drag | 256 | 173 | 15 | 3.74 ms | 5.42 ms | 27.65 ms | 43.58 ms | 7.38× | 8.67% |
| 8 | scattered | 1 | 1 | 1 | 0.26 ms | 0.55 ms | 0.24 ms | 0.44 ms | 0.91× | 0.62% |
| 8 | scattered | 4 | 4 | 4 | 1.00 ms | 1.45 ms | 1.13 ms | 1.41 ms | 1.12× | 2.32% |
| 8 | scattered | 16 | 16 | 17 | 3.98 ms | 4.36 ms | 4.20 ms | 4.58 ms | 1.05× | 9.22% |
| 8 | scattered | 64 | 64 | 62 | 14.48 ms | 15.24 ms | 16.75 ms | 19.99 ms | 1.15× | 33.57% |
...
| 16 | drag | 4 | 4 | 1 | 1.36 ms | 2.61 ms | 4.29 ms | 6.13 ms | 3.14× | 1.81% |
| 16 | drag | 16 | 16 | 2 | 2.68 ms | 4.16 ms | 17.70 ms | 25.88 ms | 6.58× | 3.56% |
...
| 16 | scattered | 1 | 1 | 1 | 1.03 ms | 1.63 ms | 1.01 ms | 1.56 ms | 0.97× | 1.37% |
| 16 | scattered | 4 | 4 | 3 | 4.01 ms | 5.02 ms | 4.52 ms | 6.11 ms | 1.12× | 5.32% |
| 16 | scattered | 16 | 16 | 14 | 17.89 ms | 20.73 ms | 19.59 ms | 22.00 ms | 1.09× | 23.75% |
| 16 | scattered | 64 | 64 | 41 | 52.43 ms | 68.24 ms | 83.01 ms | 96.57 ms | 1.58× | 69.62% |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| uniform | global | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 0.71 | 1069.84 µs | 4599.86 µs |
| uniform | per-cluster | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 7.56 | 989.04 µs | 3515.95 µs |
| uniform | per-Segment | never | 0 | 71.63% | 0.00% | 28.36% | 0.00% | 41.97 | 1020.92 µs | 5558.00 µs |
| uniform | global | 64 Ticks | 64 | 49.36% | 22.26% | 28.36% | 0.00% | 0.71 | 1894.18 µs | 6402.68 µs |
| uniform | per-cluster | 64 Ticks | 64 | 70.62% | 1.00% | 28.36% | 0.00% | 7.56 | 1097.14 µs | 3811.33 µs |
| uniform | per-Segment | 64 Ticks | 64 | 71.60% | 0.02% | 28.36% | 0.00% | 41.97 | 1068.26 µs | 3909.86 µs |
| uniform | global | 16 Ticks | 256 | 20.87% | 50.75% | 28.36% | 0.00% | 0.71 | 3050.73 µs | 8329.87 µs |
| uniform | per-cluster | 16 Ticks | 256 | 66.25% | 5.37% | 28.36% | 0.00% | 7.60 | 1344.45 µs | 5841.88 µs |
| uniform | per-Segment | 16 Ticks | 256 | 70.19% | 1.44% | 28.36% | 0.00% | 42.79 | 1283.66 µs | 5243.22 µs |
| uniform | global | 4 Ticks | 1021 | 6.59% | 65.03% | 28.36% | 0.00% | 0.71 | 3713.37 µs | 7187.22 µs |
| uniform | per-cluster | 4 Ticks | 1021 | 57.49% | 14.13% | 28.36% | 0.00% | 7.64 | 1984.14 µs | 5885.38 µs |
| uniform | per-Segment | 4 Ticks | 1021 | 68.99% | 2.63% | 28.36% | 0.00% | 42.80 | 1409.97 µs | 4513.86 µs |
| decay L=256 | global | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 0.69 | 212.97 µs | 956.63 µs |
| decay L=256 | per-cluster | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 2.55 | 206.74 µs | 910.78 µs |
| decay L=256 | per-Segment | never | 0 | 69.31% | 0.00% | 30.68% | 0.00% | 15.20 | 212.76 µs | 953.00 µs |
| decay L=256 | global | 64 Ticks | 64 | 47.99% | 21.31% | 30.68% | 0.00% | 0.69 | 370.66 µs | 2192.93 µs |
| decay L=256 | per-cluster | 64 Ticks | 64 | 68.53% | 0.78% | 30.68% | 0.00% | 2.55 | 228.95 µs | 1453.73 µs |
| decay L=256 | per-Segment | 64 Ticks | 64 | 69.21% | 0.09% | 30.68% | 0.00% | 15.20 | 232.44 µs | 1918.17 µs |
| decay L=256 | global | 16 Ticks | 256 | 20.50% | 48.80% | 30.68% | 0.00% | 0.69 | 612.88 µs | 3436.08 µs |
| decay L=256 | per-cluster | 16 Ticks | 256 | 66.40% | 2.90% | 30.68% | 0.00% | 2.56 | 310.14 µs | 1993.05 µs |
| decay L=256 | per-Segment | 16 Ticks | 256 | 68.57% | 0.73% | 30.68% | 0.00% | 15.35 | 287.72 µs | 3167.42 µs |
| decay L=256 | global | 4 Ticks | 1021 | 6.51% | 62.71% | 30.76% | 0.09% | 0.69 | 941.48 µs | 3270.74 µs |
| decay L=256 | per-cluster | 4 Ticks | 1021 | 61.27% | 7.95% | 30.76% | 0.09% | 2.56 | 502.95 µs | 1880.46 µs |
| decay L=256 | per-Segment | 4 Ticks | 1021 | 67.84% | 1.39% | 30.76% | 0.09% | 15.36 | 530.75 µs | 3055.21 µs |
| monocentric L=512 | global | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 0.69 | 812.20 µs | 2809.47 µs |
| monocentric L=512 | per-cluster | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 6.55 | 834.33 µs | 3159.31 µs |
| monocentric L=512 | per-Segment | never | 0 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 880.87 µs | 3358.48 µs |
| monocentric L=512 | global | 64 Ticks | 64 | 48.63% | 21.14% | 30.22% | 0.00% | 0.69 | 1622.29 µs | 4982.04 µs |
| monocentric L=512 | per-cluster | 64 Ticks | 64 | 69.16% | 0.61% | 30.22% | 0.00% | 6.55 | 964.84 µs | 3093.97 µs |
| monocentric L=512 | per-Segment | 64 Ticks | 64 | 69.77% | 0.00% | 30.22% | 0.00% | 37.58 | 844.18 µs | 3365.68 µs |
| monocentric L=512 | global | 16 Ticks | 256 | 20.94% | 48.82% | 30.22% | 0.00% | 0.69 | 2496.81 µs | 5560.16 µs |
| monocentric L=512 | per-cluster | 16 Ticks | 256 | 65.42% | 4.34% | 30.22% | 0.00% | 6.55 | 1145.99 µs | 4362.13 µs |
| monocentric L=512 | per-Segment | 16 Ticks | 256 | 68.67% | 1.09% | 30.22% | 0.00% | 37.85 | 976.81 µs | 3750.53 µs |
| monocentric L=512 | global | 4 Ticks | 1021 | 6.44% | 63.33% | 30.22% | 0.00% | 0.69 | 2977.64 µs | 10370.13 µs |
| monocentric L=512 | per-cluster | 4 Ticks | 1021 | 57.10% | 12.67% | 30.22% | 0.00% | 6.56 | 1507.14 µs | 4405.74 µs |
| monocentric L=512 | per-Segment | 4 Ticks | 1021 | 67.70% | 2.07% | 30.22% | 0.00% | 37.87 | 1049.63 µs | 3865.28 µs |
...
- **Run duration** 34.28 s — from 12:08:34 UTC to 12:09:08 UTC, **which is what makes the duration checkable rather than asserted**
- **Load average, at start** 4.97 / 3.08 / 2.63 (1 / 5 / 15 min)
- **Load average, at end** 4.32 / 3.10 / 2.65 (1 / 5 / 15 min)
- **CPU stall** 433,940 µs over the run — 1.26% of it
- **Memory stall** 0 µs over the run — 0.00% of it
- **IO stall** 15,310 µs over the run — 0.04% of it
