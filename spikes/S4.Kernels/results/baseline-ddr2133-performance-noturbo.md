## S4 baseline — `ddr2133-performance-noturbo`

Recorded 2026-07-31 12:04 UTC. Sustained window 10s. GB means 1e9 bytes. Copy rate is bytes delivered; traffic counts the read as well.
...
|---|---|---|---|
| 16 KiB | 60.9 GB/s | 59.3 GB/s | 118.7 GB/s |
| 64 KiB | 36.8 GB/s | 36.0 GB/s | 72.0 GB/s |
| 512 KiB | 24.0 GB/s | 23.6 GB/s | 47.3 GB/s |
| 4 MiB | 16.8 GB/s | 13.7 GB/s | 27.5 GB/s |
| 32 MiB | 13.9 GB/s | 13.3 GB/s | 26.5 GB/s |
| 256 MiB | 13.0 GB/s | 12.8 GB/s | 25.7 GB/s |

### Sustained single-threaded `memcpy` — the denominator

256 MiB per copy, 471 copies.

| Statistic | Copy rate | Traffic |
|---|---|---|
| best | 13.1 GB/s | 26.2 GB/s |
| **median** | **12.9 GB/s** | **25.9 GB/s** |
| p95 (slow tail) | 11.8 GB/s | 23.6 GB/s |
| worst | 6.6 GB/s | 13.3 GB/s |

Clock during the window: 2900 MHz at start, 2899 MHz mean, 2900 MHz at end.

### Sustained single-threaded read (secondary)

256 MiB scanned 147 times: median **13.2 GB/s**, best 14.2 GB/s, p95 12.4 GB/s. Read-only, so copy rate and traffic are the same figure.
