...
four decisions settled and tasks 1 through 6 shipped**, tasks 1 and 2 on 2026-08-18 and tasks 3 to 6
on 2026-08-19, so **cars now park, the flanking Legs cost something, and the occupancy is checked
against the Citizens holding it**, and `--parking` is the tenth runner mode; task 8 — the long
acceptance run and the two questions it ratifies — is the last one left.
