...
four decisions settled and task 1 shipped 2026-08-18**, so **the supply exists and nothing parks in it
yet**; task 2 is next. **Milestone 8 — Save/load**, scoped the same evening (`plans/0030-save-load.md`), nine
