...
| **4** | tidy | **Delete `spikes/S4.Kernels/`** — S4 task 11, open since the spike closed, gated on nothing | [`0004`](0004-s4-kernel-benchmark.md) | A deletion that size is taken deliberately, not as a consequence of a green suite |
