...
derived from.
**No gate is red anywhere in the corpus**, and no session gates a slice any more. S4, S0a, S0b, S2 R0–R8 and
...
| **F** | `adr/0008` — walking is a simulated Leg | ⚠ **IN FLIGHT 2026-08-11.** **PROMOTED 2026-08-11 — see *Do these next* row 5.** Written from research. It is what makes 5b *the irreversible milestone*. Brief: [`0021`](0021-trips-legs-and-the-pedestrian-layer.md). **One sitting** — D task 0 already ran its typing pass | milestone 5b |
