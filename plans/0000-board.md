...
|---|---|---|---|---|
| **1** | code | **Milestone 12 — the District Pool.** Decomposed into ten tasks; **1, 2 and 3 shipped 2026-08-22** — the two-centre world, the density field, and the watershed that reads it. **Task 4 is next: re-evaluation.** ⚠ **Task 5 is blocked on row 5 below** | [`0037`](0037-goods-between-buildings-the-district-pool.md) | The ungated row at the head of the sequence, and **the only root with a consumer already in the build** |
