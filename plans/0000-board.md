...
| **K2** | `06`'s Phase 2 **ordering** only | Re-derive the sequence and place the **seventeen mechanisms `06` lists as having no milestone**. **Last** — E and G move what it sequences | Planning Phase 2 at all |
