...
| **F** | `adr/0008` — walking is a simulated Leg | **PROMOTED 2026-08-11 — see *Do these next* row 5.** Written from research. It is what makes 5b *the irreversible milestone*. Brief: [`0021`](0021-trips-legs-and-the-pedestrian-layer.md). **One sitting** — D task 0 already ran its typing pass | milestone 5b |
