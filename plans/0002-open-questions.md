...
**Three open.** Two are routing's — the Epoch's granularity for the Parking Shed and how coarse a
routing destination may be — and the third is **how long a Tick is**, which is not a routing question
and is underneath both of them. **What a Trip's destination is closed 2026-08-12**, and it closed by
being **void as posed**. Everything else in this file can wait, and
