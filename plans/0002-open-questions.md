...
**Four open.** Three are routing's — the Epoch's granularity for the Parking Shed, how coarse a
routing destination may be, and what a Trip's destination is — and the fourth is **how long a Tick
is**, which is not a routing question and is underneath all three of them. Everything else in this file can wait, and
