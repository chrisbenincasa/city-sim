...
**113 written, numbered to `0120`; `0028` is reserved and unwritten.** Grouped by what grilled them.

⚠ **`0113`–`0118` are missing from this branch and are not free** — they are **claimed by the
unmerged `milestone-10-conserved-money` worktree** and arrive at merge. (`0110`–`0112` were
milestone 8's and arrived when `main` merged in on 2026-08-19.) So a **gap in this column is not
