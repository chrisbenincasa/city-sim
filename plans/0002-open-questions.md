...
|---|---|---|
| **Industrial pollution kernel** | separable tent, 1,024 m (8 Cells). **World-creation, hash-bearing** | The plume range's source — section B. The corpus's own note is that the 1–10 km band is **10× wide**, so this is a number chosen from the middle of a range nobody narrowed |
