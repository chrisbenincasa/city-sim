...
| 1 | **Session W** — the Provider kind's content, three of four questions settled and the fourth handed to milestone 26. It reversed its own brief three times, each time on the user's challenge: a misquoted demand rule, a mechanism reasoned about from what it ought to do, and a proposal that was a named exploit | 2026-08-25 | [`0043`](0043-session-w-the-provider-kinds-content.md), [`adr/0163`](../docs/adr/0163-demand-for-a-shop-is-elapsed-unserved-need-in-reach-and-building-claims-it.md)–[`adr/0166`](../docs/adr/0166-a-business-runs-rules-and-its-rules-live-as-long-as-its-tenancy.md) |
| 3 | **The `adr/0164` key sweep**, raised by the user and run 2026-09-01. 169 leaf keys walked; the hits were a **fourth shape** the ADR did not predict — eight keys the loader refuses **by name** and the generated schema advertised anyway. Also the demonstration census and a **13,618-line** comment collapse across the folder | 2026-09-01 | [`0050`](0050-the-ruleset-sweep.md), [`adr/0164`](../docs/adr/0164-a-ruleset-key-is-designer-facing-or-it-belongs-in-the-instrument.md) |
