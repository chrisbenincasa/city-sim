...
| H | `adr/0009` — parking is modelled supply. Cleared milestone 8, and discharged **M**'s remainder as a side effect | 2026-08-12 | [`adr/0083`](../docs/adr/0083-a-sheds-use-is-the-arrival-query-and-a-stale-shed-is-wrong-by-a-bounded-walk.md), [`adr/0084`](../docs/adr/0084-parking-occupancy-is-two-checks-and-an-invariant-over-absent-state-cannot-be-written.md) |
...
| J | `05 §7`, map size, Outside Connection layout. Cleared milestone 10, then re-opened its own map half into [`adr/0089`](../docs/adr/0089-the-map-is-sized-by-how-many-commutes-fit-across-it.md) | 2026-08-12 | [`0024`](0024-session-j-the-save-the-map-and-the-outside.md) |
