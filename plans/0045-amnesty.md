...
| 20 | **A CITIZEN GOES SHOPPING.** Before 19: a second Trip generator changes the daily activity that row will measure. | **In progress — [PR #5](https://github.com/chrisbenincasa/city-sim/pull/5)** (`codex/shopping`), open as of 2026-09-06; not yet merged. |
